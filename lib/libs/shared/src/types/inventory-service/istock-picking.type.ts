...
import {
	StockPickingMoveType,
	StockPickingState,
	StockReferentType,
} from '../../enum';

export namespace IStockPicking {
	export interface ICreateStockPicking {
	...
	export interface IUpdateStockPicking
		extends Omit<Partial<ICreateStockPicking>, 'shop_id' | 'picking_type_id'> {}

	export interface IStockPickingResponse extends BaseResponse {
