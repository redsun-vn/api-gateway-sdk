...
export namespace IStocktakeLine {
	export interface ICreateStocktakeLine {
	...
	export interface IUpdateStocktakeLine {
		qantity?: number;
		inventoryQuantity?: number;
		differentQuantity?: number;
	}

	export interface IStocktakeLineResponse extends BaseResponse {
