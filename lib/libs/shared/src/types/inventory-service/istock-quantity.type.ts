...
export namespace IStockQuantity {
	export interface ICreateStockQuantity {
	...
	export interface IUpdateStockQuantity {
		inventoryQuantity?: number;
		partner_id?:
			| (number & tags.Type<'uint64'>)
			| (string & tags.Format<'uuid'>);
	...
	export interface IStockQuantityResponse extends BaseResponse {
