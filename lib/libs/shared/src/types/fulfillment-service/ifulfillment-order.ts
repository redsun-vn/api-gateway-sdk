...
export namespace IFulfillmentOrder {
	export interface ICreateFulfillmentOrder {
	...
	export interface ICancelFulfillmentOrder {
		cancelReason: string;
	}

	export interface ICreateFulfillmentOrderItems {
		// infor fulfillment
		fulfillHoleReason?: string;
		fulfillHoleReasonNotes?: string;
	...
	export interface IFulfillmentOrderRequestShipping {
		cod: number;
	...
	export interface IUpdateFulfillmentOrder {
	...
	export interface IFulfillmentOrderResponse {
		id: string | number;
		uuid: string;
	...
	export interface IFulfillmentOrderDetailResponse {
		id: string | number;
		uuid?: string;
		shop_id: string | number;
		staff_id: string | number;
