...
export namespace IPartner {
	export interface ICreate {
		branch_id?: number & tags.Type<'int32'>;
		user_id?: string;
		created_by_id: string; // id Staff
	...
	export type TypePartnerUpload = 'customer' | 'supplier';
	...
	export interface IPartnerResponse extends BaseResponse {
