...
(function (OrderCombiningPromotionType) {
    ...
    OrderCombiningPromotionType["PARTNER_LEVEL"] = "partner_level";
    OrderCombiningPromotionType["PARTNER_POINT"] = "partner_point";
    ...
    OrderCombiningPromotionType["NEXT_ORDER"] = "next_order";
...
(function (OrderFinancialStatus) {
    ...
    OrderFinancialStatus["DEBT"] = "debt";
    OrderFinancialStatus["DEBT_PAID"] = "debt_paid";
...
(function (SaleOrderStatus) {
    SaleOrderStatus["DRAFT"] = "draft";
    SaleOrderStatus["PENDING_APPROVAL"] = "pending_approval";
    SaleOrderStatus["APPROVED"] = "approved";
    SaleOrderStatus["SENT"] = "sent";
    SaleOrderStatus["SALE_ORDER"] = "sale";
    SaleOrderStatus["DONE"] = "done";
    SaleOrderStatus["CANCEL"] = "cancel";
})(SaleOrderStatus || (exports.SaleOrderStatus = SaleOrderStatus = {}));
var SaleOrderApprovalStatus;
(function (SaleOrderApprovalStatus) {
    SaleOrderApprovalStatus["PENDING"] = "pending";
    SaleOrderApprovalStatus["APPROVED"] = "approved";
    SaleOrderApprovalStatus["REJECTED"] = "rejected";
    SaleOrderApprovalStatus["CANCELLED"] = "cancelled";
})(SaleOrderApprovalStatus || (exports.SaleOrderApprovalStatus = SaleOrderApprovalStatus = {}));
var SaleOrderApprovalTierStatus;
(function (SaleOrderApprovalTierStatus) {
    SaleOrderApprovalTierStatus["PENDING"] = "pending";
    SaleOrderApprovalTierStatus["APPROVED"] = "approved";
    SaleOrderApprovalTierStatus["SKIPPED"] = "skipped";
})(SaleOrderApprovalTierStatus || (exports.SaleOrderApprovalTierStatus = SaleOrderApprovalTierStatus = {}));
var SaleOrderApprovalEventType;
(function (SaleOrderApprovalEventType) {
    SaleOrderApprovalEventType["SUBMITTED"] = "submitted";
    SaleOrderApprovalEventType["TIER_APPROVED"] = "tier_approved";
    SaleOrderApprovalEventType["APPROVED"] = "approved";
    SaleOrderApprovalEventType["REJECTED"] = "rejected";
    SaleOrderApprovalEventType["CANCELLED"] = "cancelled";
    SaleOrderApprovalEventType["REOPENED"] = "reopened";
    SaleOrderApprovalEventType["WARNING"] = "warning";
    SaleOrderApprovalEventType["BREACH"] = "breach";
    SaleOrderApprovalEventType["ESCALATION"] = "escalation";
})(SaleOrderApprovalEventType || (exports.SaleOrderApprovalEventType = SaleOrderApprovalEventType = {}));
var FEE_CALCULATION_TYPE;
(function (FEE_CALCULATION_TYPE) {
    FEE_CALCULATION_TYPE["FIXED"] = "FIXED";
    FEE_CALCULATION_TYPE["WEIGHT_BASED"] = "WEIGHT_BASED";
    FEE_CALCULATION_TYPE["DISTANCE_BASED"] = "DISTANCE_BASED";
    FEE_CALCULATION_TYPE["PROVIDER_API"] = "PROVIDER_API";
    FEE_CALCULATION_TYPE["CUSTOM_FORMULA"] = "CUSTOM_FORMULA";
})(FEE_CALCULATION_TYPE || (exports.FEE_CALCULATION_TYPE = FEE_CALCULATION_TYPE = {}));
var MARKUP_TYPE;
(function (MARKUP_TYPE) {
    MARKUP_TYPE["FIXED"] = "FIXED";
    MARKUP_TYPE["PERCENTAGE"] = "PERCENTAGE";
})(MARKUP_TYPE || (exports.MARKUP_TYPE = MARKUP_TYPE = {}));
exports.FEE_CALCULATION_DESCRIPTION = {
