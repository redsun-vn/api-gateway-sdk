...
(function (SaleOrdersPermission) {
    SaleOrdersPermission["VIEW"] = "sale_order-view";
    SaleOrdersPermission["CREATE"] = "sale_order-create";
    SaleOrdersPermission["UPDATE"] = "sale_order-update";
    SaleOrdersPermission["DELETE"] = "sale_order-delete";
    SaleOrdersPermission["APPROVE"] = "sale_order-approve";
    SaleOrdersPermission["CONFIG"] = "sale_order-config";
