...
exports.update = exports.create = exports.$delete = exports.findOne = void 0;
...
(function (findOne) {
    ...
    findOne.path = (id) => `/payments/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/payments/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/payments/${encodeURIComponent(id?.toString() ?? "null")}`;
