...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shipping-methods";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shipping-methods/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shipping-methods/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shipping-methods/${encodeURIComponent(id?.toString() ?? "null")}`;
