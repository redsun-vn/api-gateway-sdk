...
(function (findOne) {
    ...
    findOne.path = (id) => `/shipping-methods/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shipping-methods/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shipping-methods/${encodeURIComponent(id ?? "null")}`;
