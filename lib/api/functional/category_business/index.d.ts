...
export declare namespace findAll {
    ...
    const METADATA: {
        readonly method: "GET";
        readonly path: "/category-business";
...
export declare namespace findOne {
    ...
    const METADATA: {
        readonly method: "GET";
        readonly path: "/category-business/:id";
        readonly request: null;
        readonly response: {
            readonly type: "application/json";
            readonly encrypted: false;
...
export declare namespace create {
    type Input = Resolved<ICategoryBusiness.ICreate>;
    type Output = Primitive<IResponse<ICategoryBusiness.ICategoryBusinessResponse>>;
    const METADATA: {
...
export declare namespace update {
    type Input = Resolved<ICategoryBusiness.IUpdate>;
