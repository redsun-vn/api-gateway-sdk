...
(function (findOne) {
    ...
    findOne.path = (id) => `/category-business/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/category-business/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/category-business/${encodeURIComponent(id?.toString() ?? "null")}`;
