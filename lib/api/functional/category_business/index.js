...
(function (findOne) {
    ...
    findOne.path = (id) => `/category-business/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/category-business/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/category-business/${encodeURIComponent(id ?? "null")}`;
