...
exports.deactive = exports.findOne = exports.print = exports.cancel = exports.publish_signature = exports.publish = exports.upsert = exports.test_connection = void 0;
...
exports.publish_signature = __importStar(require("./publish_signature"));
...
(function (findOne) {
    ...
    findOne.path = (shopId) => `/fpt-invoice/${encodeURIComponent(shopId?.toString() ?? "null")}`;
...
(function (deactive) {
    deactive.METADATA = {
        method: "DELETE",
        path: "/fpt-invoice/:shopId/deactive",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    deactive.path = (shopId) => `/fpt-invoice/${encodeURIComponent(shopId?.toString() ?? "null")}/deactive`;
