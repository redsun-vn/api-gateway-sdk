...
(function (publishInvoiceWithSignature) {
    publishInvoiceWithSignature.METADATA = {
        method: "POST",
        path: "/fpt-invoice/publish-signature/:orderId",
        request: {
    ...
    publishInvoiceWithSignature.path = (orderId) => `/fpt-invoice/publish-signature/${encodeURIComponent(orderId?.toString() ?? "null")}`;
