...
(function (updateProviderShop) {
    ...
    updateProviderShop.path = (id) => `/shop/omnichannel/configs/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (deleteProviderShopById) {
    ...
    deleteProviderShopById.path = (id) => `/shop/omnichannel/configs/${encodeURIComponent(id?.toString() ?? "null")}`;
