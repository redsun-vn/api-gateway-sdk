...
(function (getProviderShops) {
    getProviderShops.METADATA = {
        method: "GET",
        path: "/shop/omnichannel/configs/provider/:provider",
        request: null,
        response: {
    ...
    getProviderShops.path = (provider) => `/shop/omnichannel/configs/provider/${encodeURIComponent(provider?.toString() ?? "null")}`;
