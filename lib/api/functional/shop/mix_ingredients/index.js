...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/mix-ingredients";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/mix-ingredients/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/mix-ingredients";
...
(function (update) {
    ...
    update.path = (id) => `/shop/mix-ingredients/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/mix-ingredients/${encodeURIComponent(id?.toString() ?? "null")}`;
