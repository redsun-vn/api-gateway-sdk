...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/mix-ingredients/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/mix-ingredients/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/mix-ingredients/${encodeURIComponent(id ?? "null")}`;
