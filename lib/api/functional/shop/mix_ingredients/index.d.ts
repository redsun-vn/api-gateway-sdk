...
import type { IMixIngredient } from "../../../../libs/shared/src/types/product-service/imix-ingredient";
...
export declare namespace create {
    type Input = Resolved<IMixIngredient.IReqCreateMixIngredient>;
    type Output = Primitive<IResponse<IMixIngredient.IMixIngredientResponse>>;
    const METADATA: {
...
export declare namespace update {
    type Input = Resolved<IMixIngredient.IUpdateMixIngredient>;
    type Output = Primitive<IResponse<IMixIngredient.IMixIngredientResponse>>;
    const METADATA: {
        readonly method: "PUT";
        readonly path: "/shop/mix-ingredients/:id";
