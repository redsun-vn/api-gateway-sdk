...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/cms/template-categories",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/cms/template-categories";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/cms/template-categories/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/cms/template-categories/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/cms/template-categories";
...
(function (update) {
    ...
    update.path = (id) => `/shop/cms/template-categories/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/cms/template-categories/${encodeURIComponent(id?.toString() ?? "null")}`;
