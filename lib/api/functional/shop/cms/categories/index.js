...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/cms/categories";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/cms/categories/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/cms/categories/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/cms/categories";
...
(function (update) {
    ...
    update.path = (id) => `/shop/cms/categories/${encodeURIComponent(id?.toString() ?? "null")}`;
