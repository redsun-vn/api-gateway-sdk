...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/cms/documents";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/cms/documents/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/cms/documents/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/cms/documents";
...
(function (update) {
    ...
    update.path = (id) => `/shop/cms/documents/${encodeURIComponent(id?.toString() ?? "null")}`;
