...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/cms/tags/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/cms/tags/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/cms/tags/${encodeURIComponent(id?.toString() ?? "null")}`;
