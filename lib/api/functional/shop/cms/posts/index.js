...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/cms/posts/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/cms/posts/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/cms/posts/${encodeURIComponent(id?.toString() ?? "null")}`;
