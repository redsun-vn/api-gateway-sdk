...
export * as ensure_default from "./ensure_default";
...
export declare namespace findOne {
    ...
    const METADATA: {
        readonly method: "GET";
        readonly path: "/shop/cms/menus/:id";
        readonly request: null;
        readonly response: {
            readonly type: "application/json";
            readonly encrypted: false;
...
export declare namespace create {
    type Input = Resolved<ICMSMenu.ICreateReq>;
    type Output = Primitive<IResponse<ICMSMenu.IResponse>>;
    const METADATA: {
...
export declare namespace update {
    type Input = Resolved<ICMSMenu.IUpdateReq>;
    type Output = Primitive<IResponse<ICMSMenu.IResponse>>;
    const METADATA: {
        readonly method: "PUT";
        readonly path: "/shop/cms/menus/:id";
