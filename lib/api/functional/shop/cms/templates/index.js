...
exports.update = exports.create = exports.$delete = exports.findOne = exports.findAll = exports.groups = void 0;
...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/cms/templates";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/cms/templates/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/cms/templates/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/cms/templates";
...
(function (update) {
    ...
    update.path = (id) => `/shop/cms/templates/${encodeURIComponent(id?.toString() ?? "null")}`;
