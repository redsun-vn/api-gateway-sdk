...
exports.duplicate = exports.update = exports.create = exports.$delete = exports.findOne = exports.findAll = void 0;
...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/cms/themes";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/cms/themes/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/cms/themes/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/cms/themes/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (duplicate) {
    duplicate.METADATA = {
        method: "POST",
        path: "/shop/cms/themes/duplicate",
        request: {
            type: "application/json",
            encrypted: false,
        },
    ...
    duplicate.path = () => "/shop/cms/themes/duplicate";
