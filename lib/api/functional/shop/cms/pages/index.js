...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/cms/pages/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/cms/pages/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/cms/pages/${encodeURIComponent(id?.toString() ?? "null")}`;
