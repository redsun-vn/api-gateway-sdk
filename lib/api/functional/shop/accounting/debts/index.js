...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/accounting/debts";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/accounting/debts/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/accounting/debts";
...
(function (update) {
    ...
    update.path = (id) => `/shop/accounting/debts/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/accounting/debts/${encodeURIComponent(id?.toString() ?? "null")}`;
