...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/hr/attendance/shifts",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/hr/attendance/shifts";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/hr/attendance/shifts/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/hr/attendance/shifts/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/hr/attendance/shifts";
...
(function (update) {
    ...
    update.path = (id) => `/shop/hr/attendance/shifts/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/hr/attendance/shifts/${encodeURIComponent(id?.toString() ?? "null")}`;
