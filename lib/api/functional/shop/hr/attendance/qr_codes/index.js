...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/hr/attendance/qr-codes",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/hr/attendance/qr-codes";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/hr/attendance/qr-codes/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/hr/attendance/qr-codes/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/hr/attendance/qr-codes";
...
(function (update) {
    ...
    update.path = (id) => `/shop/hr/attendance/qr-codes/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/hr/attendance/qr-codes/${encodeURIComponent(id?.toString() ?? "null")}`;
