...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/hr/contract-types";
...
(function (create) {
    ...
    create.path = () => "/shop/hr/contract-types";
...
(function (update) {
    update.METADATA = {
        method: "PUT",
        path: "/shop/hr/contract-types/:id",
        request: {
            type: "application/json",
            encrypted: false,
        },
    ...
    update.path = (id) => `/shop/hr/contract-types/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/hr/contract-types/${encodeURIComponent(id?.toString() ?? "null")}`;
