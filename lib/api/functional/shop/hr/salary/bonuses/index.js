...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/hr/salary/bonuses";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/hr/salary/bonuses/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/hr/salary/bonuses/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/hr/salary/bonuses";
...
(function (update) {
    ...
    update.path = (id) => `/shop/hr/salary/bonuses/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/hr/salary/bonuses/${encodeURIComponent(id?.toString() ?? "null")}`;
