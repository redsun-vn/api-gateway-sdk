...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/hr/salary/performances",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/hr/salary/performances";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/hr/salary/performances/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/hr/salary/performances/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/hr/salary/performances";
...
(function (update) {
    ...
    update.path = (id) => `/shop/hr/salary/performances/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/hr/salary/performances/${encodeURIComponent(id?.toString() ?? "null")}`;
