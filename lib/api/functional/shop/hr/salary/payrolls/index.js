...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/hr/salary/payrolls";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/hr/salary/payrolls/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/hr/salary/payrolls/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/hr/salary/payrolls";
...
(function (update) {
    ...
    update.path = (id) => `/shop/hr/salary/payrolls/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/hr/salary/payrolls/${encodeURIComponent(id?.toString() ?? "null")}`;
