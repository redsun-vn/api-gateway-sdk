...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/hr/salary/leave-types",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/hr/salary/leave-types";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/hr/salary/leave-types/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/hr/salary/leave-types/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/hr/salary/leave-types";
...
(function (update) {
    ...
    update.path = (id) => `/shop/hr/salary/leave-types/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/hr/salary/leave-types/${encodeURIComponent(id?.toString() ?? "null")}`;
