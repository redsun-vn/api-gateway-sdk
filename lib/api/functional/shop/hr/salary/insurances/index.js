...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/hr/salary/insurances",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/hr/salary/insurances";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/hr/salary/insurances/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/hr/salary/insurances/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/hr/salary/insurances";
...
(function (update) {
    ...
    update.path = (id) => `/shop/hr/salary/insurances/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/hr/salary/insurances/${encodeURIComponent(id?.toString() ?? "null")}`;
