...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/hr/salary/holidays";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/hr/salary/holidays/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/hr/salary/holidays/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/hr/salary/holidays";
...
(function (update) {
    ...
    update.path = (id) => `/shop/hr/salary/holidays/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/hr/salary/holidays/${encodeURIComponent(id?.toString() ?? "null")}`;
