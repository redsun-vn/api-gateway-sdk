...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/hr/salary/configs";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/hr/salary/configs/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/hr/salary/configs/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/hr/salary/configs";
...
(function (update) {
    ...
    update.path = (id) => `/shop/hr/salary/configs/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/hr/salary/configs/${encodeURIComponent(id?.toString() ?? "null")}`;
