...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/hr/salary/allowances",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/hr/salary/allowances";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/hr/salary/allowances/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/hr/salary/allowances/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/hr/salary/allowances";
...
(function (update) {
    ...
    update.path = (id) => `/shop/hr/salary/allowances/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/hr/salary/allowances/${encodeURIComponent(id?.toString() ?? "null")}`;
