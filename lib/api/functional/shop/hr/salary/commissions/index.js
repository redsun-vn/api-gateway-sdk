...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/hr/salary/commissions",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/hr/salary/commissions";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/hr/salary/commissions/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/hr/salary/commissions/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/hr/salary/commissions";
...
(function (update) {
    ...
    update.path = (id) => `/shop/hr/salary/commissions/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/hr/salary/commissions/${encodeURIComponent(id?.toString() ?? "null")}`;
