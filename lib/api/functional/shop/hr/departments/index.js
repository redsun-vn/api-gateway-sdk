...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/hr/departments";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/hr/departments/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/hr/departments";
...
(function (update) {
    ...
    update.path = (id) => `/shop/hr/departments/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/hr/departments/${encodeURIComponent(id?.toString() ?? "null")}`;
