...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/groups/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/groups/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/groups/${encodeURIComponent(id ?? "null")}`;
