...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/inventory/stock-locations",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/inventory/stock-locations";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/inventory/stock-locations/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/inventory/stock-locations/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/inventory/stock-locations";
...
(function (update) {
    ...
    update.path = (id) => `/shop/inventory/stock-locations/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/inventory/stock-locations/${encodeURIComponent(id?.toString() ?? "null")}`;
