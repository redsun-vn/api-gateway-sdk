...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        return `/shop/inventory/stock-pickings${encoded.length ? `?${encoded}` : ""}`;
        ;
    };
...
(function (findOne) {
    ...
    findOne.path = (id) => {
        return `/shop/inventory/stock-pickings/${encodeURIComponent(id ?? "null")}`;
    };
...
(function (create) {
    ...
    create.path = () => {
        return `/shop/inventory/stock-pickings`;
    };
