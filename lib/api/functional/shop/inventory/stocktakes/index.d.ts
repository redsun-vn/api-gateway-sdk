...
export declare namespace findAll {
    type Output = Primitive<IResponse<IResponsePagination<IStocktake.IStocktakeResponse>>>;
    const METADATA: {
        readonly method: "GET";
        readonly path: "/shop/inventory/stocktakes";
...
export declare namespace findOne {
    ...
    const METADATA: {
        readonly method: "GET";
        readonly path: "/shop/inventory/stocktakes/:id";
        readonly request: null;
        readonly response: {
            readonly type: "application/json";
            readonly encrypted: false;
...
export declare namespace create {
    type Input = Primitive<IStocktake.ICreateStocktake>;
    type Output = Primitive<IResponse<IStocktake.IStocktakeResponse>>;
    const METADATA: {
...
export declare namespace update {
    type Input = Primitive<IStocktake.IUpdateStocktake>;
    type Output = Primitive<IResponse<IStocktake.IStocktakeResponse>>;
    const METADATA: {
        readonly method: "PUT";
        readonly path: "/shop/inventory/stocktakes/:id";
