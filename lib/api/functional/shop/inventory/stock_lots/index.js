...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/inventory/stock-lots/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/inventory/stock-lots/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/inventory/stock-lots/${encodeURIComponent(id ?? "null")}`;
