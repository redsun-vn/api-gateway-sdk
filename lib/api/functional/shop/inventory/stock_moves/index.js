...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/inventory/stock-moves",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/inventory/stock-moves";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/inventory/stock-moves/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/inventory/stock-moves/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/inventory/stock-moves";
...
(function (update) {
    ...
    update.path = (id) => `/shop/inventory/stock-moves/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/inventory/stock-moves/${encodeURIComponent(id?.toString() ?? "null")}`;
