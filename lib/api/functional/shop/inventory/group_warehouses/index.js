...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        return `/shop/inventory/group-warehouses${encoded.length ? `?${encoded}` : ""}`;
        ;
    };
...
(function (findOne) {
    ...
    findOne.path = (id) => {
        return `/shop/inventory/group-warehouses/${encodeURIComponent(id ?? "null")}`;
    };
...
(function (create) {
    ...
    create.path = () => {
        return `/shop/inventory/group-warehouses`;
    };
