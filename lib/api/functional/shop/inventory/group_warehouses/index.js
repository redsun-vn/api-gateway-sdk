...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/inventory/group-warehouses",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/inventory/group-warehouses";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/inventory/group-warehouses/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/inventory/group-warehouses/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/inventory/group-warehouses";
...
(function (update) {
    ...
    update.path = (id) => `/shop/inventory/group-warehouses/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/inventory/group-warehouses/${encodeURIComponent(id?.toString() ?? "null")}`;
