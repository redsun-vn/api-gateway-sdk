...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/inventory/stock-quantity",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/inventory/stock-quantity";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/inventory/stock-quantity/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/inventory/stock-quantity/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/inventory/stock-quantity";
...
(function (update) {
    ...
    update.path = (id) => `/shop/inventory/stock-quantity/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/inventory/stock-quantity/${encodeURIComponent(id?.toString() ?? "null")}`;
