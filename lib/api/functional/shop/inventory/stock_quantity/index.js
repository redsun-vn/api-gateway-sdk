...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        return `/shop/inventory/stock-quantity${encoded.length ? `?${encoded}` : ""}`;
        ;
    };
...
(function (findOne) {
    ...
    findOne.path = (id) => {
        return `/shop/inventory/stock-quantity/${encodeURIComponent(id ?? "null")}`;
    };
...
(function (create) {
    ...
    create.path = () => {
        return `/shop/inventory/stock-quantity`;
    };
