...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/inventory/stock-routers",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/inventory/stock-routers";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/inventory/stock-routers/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/inventory/stock-routers/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/inventory/stock-routers";
...
(function (update) {
    ...
    update.path = (id) => `/shop/inventory/stock-routers/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/inventory/stock-routers/${encodeURIComponent(id?.toString() ?? "null")}`;
