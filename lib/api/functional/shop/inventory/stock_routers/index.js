...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        return `/shop/inventory/stock-routers${encoded.length ? `?${encoded}` : ""}`;
        ;
    };
...
(function (findOne) {
    ...
    findOne.path = (id) => {
        return `/shop/inventory/stock-routers/${encodeURIComponent(id ?? "null")}`;
    };
...
(function (create) {
    ...
    create.path = () => {
        return `/shop/inventory/stock-routers`;
    };
