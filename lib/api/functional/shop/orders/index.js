...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/orders/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/orders/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/orders/${encodeURIComponent(id ?? "null")}`;
