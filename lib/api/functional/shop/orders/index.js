...
exports.$delete = exports.update = exports.create = exports.findOne = exports.$export = exports.reindex = exports.findAll = exports.apply_deposit = void 0;
const PlainFetcher_1 = require("@nestia/fetcher/lib/PlainFetcher");
exports.apply_deposit = __importStar(require("./apply_deposit"));
...
async function reindex(connection, uuid) {
    return PlainFetcher_1.PlainFetcher.fetch(connection, {
        ...reindex.METADATA,
        template: reindex.METADATA.path,
        path: reindex.path(uuid),
    });
}
...
(function (reindex) {
    ...
    reindex.path = (uuid) => `/shop/orders/reindex/${encodeURIComponent(uuid?.toString() ?? "null")}`;
