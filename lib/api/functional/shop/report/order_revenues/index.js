...
exports.stats = exports.findAll = exports.$return = exports.$export = void 0;
...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/report/order-revenues",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/report/order-revenues";
...
(function (stats) {
    stats.METADATA = {
        method: "GET",
        path: "/shop/report/order-revenues/stats",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    stats.path = (query) => {
        ...
        for (const [key, value] of Object.entries(query))
            if (undefined === value)
                ...
                variables.set(key, String(value));
        const location = "/shop/report/order-revenues/stats";
        return 0 === variables.size
            ? location
            : `${location}?${variables.toString()}`;
    };
