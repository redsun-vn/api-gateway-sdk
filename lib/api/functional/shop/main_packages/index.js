...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/main-packages";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/main-packages/${encodeURIComponent(id?.toString() ?? "null")}`;
