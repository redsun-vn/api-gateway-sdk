...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/comments/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/comments/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/comments/${encodeURIComponent(id ?? "null")}`;
