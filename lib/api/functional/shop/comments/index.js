...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/comments/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/comments/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/comments/${encodeURIComponent(id?.toString() ?? "null")}`;
