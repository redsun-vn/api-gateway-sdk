...
(function (detail) {
    ...
    detail.path = (id) => `/shop/category-cards/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/category-cards/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/category-cards/${encodeURIComponent(id ?? "null")}`;
