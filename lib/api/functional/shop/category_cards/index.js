...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/category-cards";
...
(function (create) {
    ...
    create.path = () => "/shop/category-cards";
...
(function (detail) {
    ...
    detail.path = (id) => `/shop/category-cards/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/category-cards/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/category-cards/${encodeURIComponent(id?.toString() ?? "null")}`;
