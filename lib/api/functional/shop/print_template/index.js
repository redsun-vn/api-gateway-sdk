...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/print-template/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/print-template/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/print-template/${encodeURIComponent(id ?? "null")}`;
