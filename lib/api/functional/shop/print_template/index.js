...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/print-template";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/print-template/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/print-template";
...
(function (update) {
    ...
    update.path = (id) => `/shop/print-template/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/print-template/${encodeURIComponent(id?.toString() ?? "null")}`;
