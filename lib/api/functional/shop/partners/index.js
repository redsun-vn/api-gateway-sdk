...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/partners/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/partners/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/partners/${encodeURIComponent(id ?? "null")}`;
