...
exports.deactive = exports.findOne = exports.test_connection = exports.status = exports.print = exports.publish = exports.cancel = exports.upsert = void 0;
...
(function (findOne) {
    ...
    findOne.path = (shopId) => `/shop/misa-invoice/${encodeURIComponent(shopId?.toString() ?? "null")}`;
...
(function (deactive) {
    deactive.METADATA = {
        method: "DELETE",
        path: "/shop/misa-invoice/:shopId/deactive",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    deactive.path = (shopId) => `/shop/misa-invoice/${encodeURIComponent(shopId?.toString() ?? "null")}/deactive`;
