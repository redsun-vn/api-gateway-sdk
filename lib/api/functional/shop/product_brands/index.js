...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/product-brands";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/product-brands/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/product-brands";
...
(function (update) {
    ...
    update.path = (id) => `/shop/product-brands/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/product-brands/${encodeURIComponent(id?.toString() ?? "null")}`;
