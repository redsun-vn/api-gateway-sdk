...
import type { IProductBrand } from "../../../../libs/shared/src/types/product-service/iproduct-brand";
...
export declare namespace create {
    type Input = Resolved<IProductBrand.ICreateProductBrand>;
    type Output = Primitive<IResponse<IProductBrand.IDetailProductBrandResponse>>;
    const METADATA: {
...
export declare namespace update {
    type Input = Resolved<IProductBrand.IUpdateProductBrand>;
    type Output = Primitive<IResponse<IProductBrand.IDetailProductBrandResponse>>;
    const METADATA: {
        readonly method: "PUT";
        readonly path: "/shop/product-brands/:id";
