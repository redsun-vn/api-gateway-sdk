...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/payment/bank-accounts",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/payment/bank-accounts";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/payment/bank-accounts/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/payment/bank-accounts/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/payment/bank-accounts/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/payment/bank-accounts";
...
(function (update) {
    ...
    update.path = (id) => `/shop/payment/bank-accounts/${encodeURIComponent(id?.toString() ?? "null")}`;
