...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/payment/bank-accounts/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/payment/bank-accounts/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/payment/bank-accounts/${encodeURIComponent(id ?? "null")}`;
