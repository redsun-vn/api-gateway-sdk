...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/payment/transactions",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/payment/transactions";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/payment/transactions/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/payment/transactions/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/payment/transactions/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/payment/transactions";
...
(function (update) {
    ...
    update.path = (id) => `/shop/payment/transactions/${encodeURIComponent(id?.toString() ?? "null")}`;
