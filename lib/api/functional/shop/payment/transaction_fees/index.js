...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        return `/shop/payment/transaction-fees${encoded.length ? `?${encoded}` : ""}`;
        ;
    };
...
(function (findOne) {
    ...
    findOne.path = (id) => {
        return `/shop/payment/transaction-fees/${encodeURIComponent(id ?? "null")}`;
    };
...
(function (create) {
    ...
    create.path = () => {
        return `/shop/payment/transaction-fees`;
    };
