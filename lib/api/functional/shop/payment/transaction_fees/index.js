...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/payment/transaction-fees",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/payment/transaction-fees";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/payment/transaction-fees/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/payment/transaction-fees/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/payment/transaction-fees/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/payment/transaction-fees";
...
(function (update) {
    ...
    update.path = (id) => `/shop/payment/transaction-fees/${encodeURIComponent(id?.toString() ?? "null")}`;
