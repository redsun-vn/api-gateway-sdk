...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/payment/payment-gateways/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/payment/payment-gateways/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/payment/payment-gateways/${encodeURIComponent(id ?? "null")}`;
