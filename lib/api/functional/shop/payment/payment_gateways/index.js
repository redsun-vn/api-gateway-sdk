...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        return `/shop/payment/payment-gateways${encoded.length ? `?${encoded}` : ""}`;
        ;
    };
...
(function (findOne) {
    ...
    findOne.path = (id) => {
        return `/shop/payment/payment-gateways/${encodeURIComponent(id ?? "null")}`;
    };
...
(function (create) {
    ...
    create.path = () => {
        return `/shop/payment/payment-gateways`;
    };
