...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/payment/payment-gateways",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/payment/payment-gateways";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/payment/payment-gateways/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/payment/payment-gateways/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/payment/payment-gateways/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/payment/payment-gateways";
...
(function (update) {
    ...
    update.path = (id) => `/shop/payment/payment-gateways/${encodeURIComponent(id?.toString() ?? "null")}`;
