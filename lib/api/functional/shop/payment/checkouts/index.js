...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/payment/checkouts/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/payment/checkouts/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/payment/checkouts/${encodeURIComponent(id ?? "null")}`;
