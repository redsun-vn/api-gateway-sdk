...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/payment/checkouts";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/payment/checkouts/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/payment/checkouts/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/payment/checkouts/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/payment/checkouts";
...
(function (update) {
    ...
    update.path = (id) => `/shop/payment/checkouts/${encodeURIComponent(id?.toString() ?? "null")}`;
