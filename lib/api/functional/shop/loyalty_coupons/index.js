...
(function (detail) {
    ...
    detail.path = (id) => `/shop/loyalty-coupons/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/loyalty-coupons/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/loyalty-coupons/${encodeURIComponent(id ?? "null")}`;
