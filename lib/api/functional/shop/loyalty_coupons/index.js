...
(function (create) {
    ...
    create.path = () => "/shop/loyalty-coupons";
...
(function (list) {
    ...
    list.path = (query) => {
        ...
        const location = "/shop/loyalty-coupons";
...
(function (detail) {
    ...
    detail.path = (id) => `/shop/loyalty-coupons/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/loyalty-coupons/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/loyalty-coupons/${encodeURIComponent(id?.toString() ?? "null")}`;
