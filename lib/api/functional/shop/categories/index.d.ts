...
import type { ICategory } from "../../../../libs/shared/src/types/icategory";
...
export declare namespace findOne {
    type Output = Primitive<IResponse<ICategory.IDetailResponse>>;
    const METADATA: {
        readonly method: "GET";
        readonly path: "/shop/categories/:id";
        readonly request: null;
        readonly response: {
            readonly type: "application/json";
            readonly encrypted: false;
...
export declare namespace create {
    type Input = Primitive<ICategory.IReqCreateCategory>;
    type Output = Primitive<IResponse<ICategory.IDetailResponse>>;
    const METADATA: {
...
export declare namespace update {
    type Input = Primitive<ICategory.IUpdateCategory>;
    type Output = Primitive<IResponse<ICategory.IDetailResponse>>;
    const METADATA: {
        readonly method: "PUT";
        readonly path: "/shop/categories/:id";
