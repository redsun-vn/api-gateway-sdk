...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/categories/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/categories/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/categories/${encodeURIComponent(id ?? "null")}`;
