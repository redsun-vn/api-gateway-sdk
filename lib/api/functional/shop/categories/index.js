...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/categories";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/categories/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/categories/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/categories/${encodeURIComponent(id?.toString() ?? "null")}`;
