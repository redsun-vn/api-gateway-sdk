...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/product-packages";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/product-packages/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/product-packages";
...
(function (update) {
    ...
    update.path = (id) => `/shop/product-packages/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/product-packages/${encodeURIComponent(id?.toString() ?? "null")}`;
