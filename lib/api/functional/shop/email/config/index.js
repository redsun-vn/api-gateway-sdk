...
exports.deleteConfig = exports.updateConfig = exports.createConfig = exports.getConfig = exports.listConfigs = exports.test_send = exports.activate = void 0;
...
(function (listConfigs) {
    ...
    listConfigs.path = () => "/shop/email/config";
...
(function (getConfig) {
    ...
    getConfig.path = (id) => `/shop/email/config/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (createConfig) {
    ...
    createConfig.path = () => "/shop/email/config";
...
(function (updateConfig) {
    ...
    updateConfig.path = (id) => `/shop/email/config/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (deleteConfig) {
    ...
    deleteConfig.path = (id) => `/shop/email/config/${encodeURIComponent(id?.toString() ?? "null")}`;
