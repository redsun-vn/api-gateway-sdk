...
(function (create) {
    ...
    create.path = () => "/shop/reconciliations";
...
(function (list) {
    ...
    list.path = (query) => {
        ...
        const location = "/shop/reconciliations";
...
(function (detail) {
    ...
    detail.path = (id) => `/shop/reconciliations/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/reconciliations/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (cancel) {
    ...
    cancel.path = (id) => `/shop/reconciliations/${encodeURIComponent(id?.toString() ?? "null")}/cancel`;
...
(function (release) {
    ...
    release.path = (id) => `/shop/reconciliations/${encodeURIComponent(id?.toString() ?? "null")}/release`;
