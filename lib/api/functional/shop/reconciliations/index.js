...
(function (detail) {
    ...
    detail.path = (id) => `/shop/reconciliations/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/reconciliations/${encodeURIComponent(id ?? "null")}`;
...
(function (cancel) {
    ...
    cancel.path = (id) => `/shop/reconciliations/${encodeURIComponent(id ?? "null")}/cancel`;
...
(function (release) {
    ...
    release.path = (id) => `/shop/reconciliations/${encodeURIComponent(id ?? "null")}/release`;
