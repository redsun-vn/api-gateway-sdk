...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/reservation/emenu-qr-items/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/reservation/emenu-qr-items/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/reservation/emenu-qr-items/${encodeURIComponent(id ?? "null")}`;
