...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/reservation/emenu-qr-items",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/reservation/emenu-qr-items";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/reservation/emenu-qr-items/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/reservation/emenu-qr-items/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/reservation/emenu-qr-items/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/reservation/emenu-qr-items";
...
(function (update) {
    ...
    update.path = (id) => `/shop/reservation/emenu-qr-items/${encodeURIComponent(id?.toString() ?? "null")}`;
