...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/reservation/floor-plans",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/reservation/floor-plans";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/reservation/floor-plans/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/reservation/floor-plans/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/reservation/floor-plans/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/reservation/floor-plans";
...
(function (update) {
    ...
    update.path = (id) => `/shop/reservation/floor-plans/${encodeURIComponent(id?.toString() ?? "null")}`;
