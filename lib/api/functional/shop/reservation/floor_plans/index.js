...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/reservation/floor-plans/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/reservation/floor-plans/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/reservation/floor-plans/${encodeURIComponent(id ?? "null")}`;
