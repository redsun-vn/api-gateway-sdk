...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        return `/shop/reservation/floor-plans${encoded.length ? `?${encoded}` : ""}`;
        ;
    };
...
(function (findOne) {
    ...
    findOne.path = (id) => {
        return `/shop/reservation/floor-plans/${encodeURIComponent(id ?? "null")}`;
    };
...
(function (create) {
    ...
    create.path = () => {
        return `/shop/reservation/floor-plans`;
    };
