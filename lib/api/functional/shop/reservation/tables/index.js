...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/reservation/tables/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/reservation/tables/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/reservation/tables/${encodeURIComponent(id ?? "null")}`;
