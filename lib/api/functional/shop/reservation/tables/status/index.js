...
(function (getBatchStatus) {
    getBatchStatus.METADATA = {
        method: "GET",
        path: "/shop/reservation/tables/status",
        request: null,
        response: {
    ...
    getBatchStatus.path = (query) => {
        ...
        const location = "/shop/reservation/tables/status";
...
(function (getSingleStatus) {
    getSingleStatus.METADATA = {
        method: "GET",
        path: "/shop/reservation/tables/:id/status",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    getSingleStatus.path = (id) => `/shop/reservation/tables/${encodeURIComponent(id?.toString() ?? "null")}/status`;
