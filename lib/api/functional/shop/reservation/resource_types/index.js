...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/reservation/resource-types",
        request: null,
        response: {
    ...
    findAll.path = () => "/shop/reservation/resource-types";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/reservation/resource-types/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/reservation/resource-types/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/reservation/resource-types";
...
(function (update) {
    ...
    update.path = (id) => `/shop/reservation/resource-types/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/reservation/resource-types/${encodeURIComponent(id?.toString() ?? "null")}`;
