...
(function (findAll) {
    ...
    findAll.path = () => "/shop/reservation/configs";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/reservation/configs/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/reservation/configs/${encodeURIComponent(id ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/reservation/configs";
...
(function (update) {
    ...
    update.path = (id) => `/shop/reservation/configs/${encodeURIComponent(id ?? "null")}`;
