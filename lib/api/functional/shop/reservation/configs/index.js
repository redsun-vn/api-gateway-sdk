...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/reservation/configs/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/reservation/configs/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/reservation/configs/${encodeURIComponent(id?.toString() ?? "null")}`;
