...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        return `/shop/pricebook/pricebook-rules${encoded.length ? `?${encoded}` : ""}`;
        ;
    };
...
(function (findOne) {
    ...
    findOne.path = (id) => {
        return `/shop/pricebook/pricebook-rules/${encodeURIComponent(id ?? "null")}`;
    };
...
(function (create) {
    ...
    create.path = () => {
        return `/shop/pricebook/pricebook-rules`;
    };
