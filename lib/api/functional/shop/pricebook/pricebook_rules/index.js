...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/pricebook/pricebook-rules/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/pricebook/pricebook-rules/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/pricebook/pricebook-rules/${encodeURIComponent(id ?? "null")}`;
