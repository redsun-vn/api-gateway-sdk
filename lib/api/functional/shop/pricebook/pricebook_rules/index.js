...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/pricebook/pricebook-rules",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/pricebook/pricebook-rules";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/pricebook/pricebook-rules/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/pricebook/pricebook-rules/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/pricebook/pricebook-rules";
...
(function (update) {
    ...
    update.path = (id) => `/shop/pricebook/pricebook-rules/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/pricebook/pricebook-rules/${encodeURIComponent(id?.toString() ?? "null")}`;
