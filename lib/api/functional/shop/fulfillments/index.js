...
(function (detail) {
    ...
    detail.path = (id) => `/shop/fulfillments/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/fulfillments/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (cancel) {
    ...
    cancel.path = (id) => `/shop/fulfillments/${encodeURIComponent(id?.toString() ?? "null")}/cancel`;
