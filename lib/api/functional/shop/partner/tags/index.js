...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/partner/tags/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/partner/tags/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/partner/tags/${encodeURIComponent(id ?? "null")}`;
