...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/partner/tags";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/partner/tags/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/partner/tags/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/partner/tags/${encodeURIComponent(id?.toString() ?? "null")}`;
