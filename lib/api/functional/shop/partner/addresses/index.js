...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/partner/addresses/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/partner/addresses/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/partner/addresses/${encodeURIComponent(id ?? "null")}`;
