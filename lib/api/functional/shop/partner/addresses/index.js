...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/partner/addresses";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/partner/addresses/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/partner/addresses/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/partner/addresses/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/partner/addresses";
...
(function (update) {
    ...
    update.path = (id) => `/shop/partner/addresses/${encodeURIComponent(id?.toString() ?? "null")}`;
