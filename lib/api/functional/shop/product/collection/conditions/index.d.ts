...
import type { ICondition } from "../../../../../../libs/shared/src/types/product-service/icondition";
...
export declare namespace create {
    type Input = Resolved<ICondition.ICreateCondition>;
    type Output = Primitive<IResponse<ICondition.IDetailConditionResponse>>;
    const METADATA: {
...
export declare namespace update {
    type Input = Resolved<ICondition.IUpdateCondition>;
    type Output = Primitive<IResponse<ICondition.IDetailConditionResponse>>;
    const METADATA: {
        readonly method: "PUT";
        readonly path: "/shop/product/collection/conditions/:id";
