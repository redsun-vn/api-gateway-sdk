...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/product/collection/conditions",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/product/collection/conditions";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/product/collection/conditions/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/product/collection/conditions/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/product/collection/conditions";
...
(function (update) {
    ...
    update.path = (id) => `/shop/product/collection/conditions/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/product/collection/conditions/${encodeURIComponent(id?.toString() ?? "null")}`;
