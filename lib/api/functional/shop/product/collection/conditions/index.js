...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        return `/shop/product/collection/conditions${encoded.length ? `?${encoded}` : ""}`;
        ;
    };
...
(function (findOne) {
    ...
    findOne.path = (id) => {
        return `/shop/product/collection/conditions/${encodeURIComponent(id ?? "null")}`;
    };
...
(function (create) {
    ...
    create.path = () => {
        return `/shop/product/collection/conditions`;
    };
