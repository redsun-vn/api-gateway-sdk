...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/product/units";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/product/units/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/product/units";
...
(function (update) {
    ...
    update.path = (id) => `/shop/product/units/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/product/units/${encodeURIComponent(id?.toString() ?? "null")}`;
