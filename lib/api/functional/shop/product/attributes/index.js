...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/product/attributes";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/product/attributes/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/product/attributes/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/product/attributes";
...
(function (update) {
    ...
    update.path = (id) => `/shop/product/attributes/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/product/attributes/${encodeURIComponent(id?.toString() ?? "null")}`;
