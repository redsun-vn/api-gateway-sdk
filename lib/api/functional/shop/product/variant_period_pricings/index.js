...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/product/variant-period-pricings",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/product/variant-period-pricings";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/product/variant-period-pricings/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/product/variant-period-pricings/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/product/variant-period-pricings";
...
(function (update) {
    ...
    update.path = (id) => `/shop/product/variant-period-pricings/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/product/variant-period-pricings/${encodeURIComponent(id?.toString() ?? "null")}`;
