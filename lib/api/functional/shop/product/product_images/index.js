...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        return `/shop/product/product-images${encoded.length ? `?${encoded}` : ""}`;
        ;
    };
...
(function (findOne) {
    ...
    findOne.path = (id) => {
        return `/shop/product/product-images/${encodeURIComponent(id ?? "null")}`;
    };
...
(function (create) {
    ...
    create.path = () => {
        return `/shop/product/product-images`;
    };
