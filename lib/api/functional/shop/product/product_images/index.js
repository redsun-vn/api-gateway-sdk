...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/product/product-images",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/product/product-images";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/product/product-images/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/product/product-images/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/product/product-images";
...
(function (update) {
    ...
    update.path = (id) => `/shop/product/product-images/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/product/product-images/${encodeURIComponent(id?.toString() ?? "null")}`;
