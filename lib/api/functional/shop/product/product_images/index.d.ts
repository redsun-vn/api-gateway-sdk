...
import type { IProductImage } from "../../../../../libs/shared/src/types/iproduct-image.type";
...
export declare namespace create {
    type Input = Primitive<IProductImage.ICreateProductImage>;
    type Output = Primitive<IResponse<IProductImage.IProductImageResponse>>;
    const METADATA: {
...
export declare namespace update {
    type Input = Primitive<IProductImage.IUpdateProductImage>;
    type Output = Primitive<IResponse<IProductImage.IProductImageResponse>>;
    const METADATA: {
        readonly method: "PUT";
        readonly path: "/shop/product/product-images/:id";
