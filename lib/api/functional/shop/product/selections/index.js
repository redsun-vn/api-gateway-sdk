...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/product/selections";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/product/selections/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/product/selections/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/product/selections";
...
(function (update) {
    ...
    update.path = (id) => `/shop/product/selections/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/product/selections/${encodeURIComponent(id?.toString() ?? "null")}`;
