...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/product/selection-groups/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/product/selection-groups/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/product/selection-groups/${encodeURIComponent(id ?? "null")}`;
