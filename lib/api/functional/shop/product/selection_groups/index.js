...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        return `/shop/product/selection-groups${encoded.length ? `?${encoded}` : ""}`;
        ;
    };
...
(function (findOne) {
    ...
    findOne.path = (id) => {
        return `/shop/product/selection-groups/${encodeURIComponent(id ?? "null")}`;
    };
...
(function (create) {
    ...
    create.path = () => {
        return `/shop/product/selection-groups`;
    };
