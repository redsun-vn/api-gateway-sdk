...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/product/selection-groups",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/product/selection-groups";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/product/selection-groups/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/product/selection-groups/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/product/selection-groups";
...
(function (update) {
    ...
    update.path = (id) => `/shop/product/selection-groups/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/product/selection-groups/${encodeURIComponent(id?.toString() ?? "null")}`;
