...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/product/variants/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/product/variants/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/product/variants/${encodeURIComponent(id ?? "null")}`;
