...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/product/collections";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/product/collections/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/product/collections/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/product/collections";
...
(function (update) {
    ...
    update.path = (id) => `/shop/product/collections/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/product/collections/${encodeURIComponent(id?.toString() ?? "null")}`;
