...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/product/collections/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/product/collections/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/product/collections/${encodeURIComponent(id ?? "null")}`;
