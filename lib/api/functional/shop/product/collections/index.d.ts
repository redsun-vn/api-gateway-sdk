...
export declare namespace findAll {
    ...
    const METADATA: {
        readonly method: "GET";
        readonly path: "/shop/product/collections";
...
export declare namespace findOne {
    type Output = Primitive<IResponse<ICollection.IDetailCollectionResponse>>;
    const METADATA: {
        readonly method: "GET";
        readonly path: "/shop/product/collections/:id";
        readonly request: null;
        readonly response: {
            readonly type: "application/json";
            readonly encrypted: false;
...
export declare namespace create {
    type Input = Primitive<ICollection.IReqCreateCollection>;
    type Output = Primitive<IResponse<ICollection.IDetailCollectionResponse>>;
    const METADATA: {
...
export declare namespace update {
    type Input = Primitive<ICollection.IUpdateCollection>;
    type Output = Primitive<IResponse<ICollection.IDetailCollectionResponse>>;
    const METADATA: {
        readonly method: "PUT";
        readonly path: "/shop/product/collections/:id";
