...
(function (create) {
    ...
    create.path = () => "/shop/loyalty-rewards";
...
(function (detail) {
    ...
    detail.path = (id) => `/shop/loyalty-rewards/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/loyalty-rewards/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/loyalty-rewards/${encodeURIComponent(id?.toString() ?? "null")}`;
