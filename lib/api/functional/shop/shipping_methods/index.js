...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/shipping-methods";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/shipping-methods/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/shipping-methods/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/shipping-methods";
...
(function (update) {
    ...
    update.path = (id) => `/shop/shipping-methods/${encodeURIComponent(id?.toString() ?? "null")}`;
