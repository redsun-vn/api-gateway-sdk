...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/ingredients/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/ingredients/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/ingredients/${encodeURIComponent(id ?? "null")}`;
