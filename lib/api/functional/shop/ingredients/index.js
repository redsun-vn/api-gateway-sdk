...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/ingredients";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/ingredients/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/ingredients/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/ingredients/${encodeURIComponent(id?.toString() ?? "null")}`;
