...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/domains/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/domains/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/domains/${encodeURIComponent(id?.toString() ?? "null")}`;
