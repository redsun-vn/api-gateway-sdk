...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/domains/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/domains/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/domains/${encodeURIComponent(id ?? "null")}`;
