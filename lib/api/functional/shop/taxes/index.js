...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/taxes/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/taxes/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/taxes/${encodeURIComponent(id ?? "null")}`;
