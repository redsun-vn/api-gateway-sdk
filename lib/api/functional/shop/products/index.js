...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/products/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/products/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/products/${encodeURIComponent(id ?? "null")}`;
