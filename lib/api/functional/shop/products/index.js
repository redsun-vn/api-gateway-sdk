...
exports.$delete = exports.update = exports.create = exports.findOne = exports.findAll = exports.copy = void 0;
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/products/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/products/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/products/${encodeURIComponent(id?.toString() ?? "null")}`;
