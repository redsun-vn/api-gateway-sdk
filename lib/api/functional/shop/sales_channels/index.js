...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/sales-channels";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/sales-channels/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/sales-channels/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/sales-channels";
...
(function (update) {
    ...
    update.path = (id) => `/shop/sales-channels/${encodeURIComponent(id?.toString() ?? "null")}`;
