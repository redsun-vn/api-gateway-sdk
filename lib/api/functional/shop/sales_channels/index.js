...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/sales-channels/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/sales-channels/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/sales-channels/${encodeURIComponent(id ?? "null")}`;
