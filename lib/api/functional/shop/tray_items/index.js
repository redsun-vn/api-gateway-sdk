...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/tray-items";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/tray-items/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/tray-items/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/tray-items/${encodeURIComponent(id?.toString() ?? "null")}`;
