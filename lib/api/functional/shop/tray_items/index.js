...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/tray-items/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/tray-items/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/tray-items/${encodeURIComponent(id ?? "null")}`;
