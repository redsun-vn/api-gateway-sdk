...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/tags/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/tags/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/tags/${encodeURIComponent(id?.toString() ?? "null")}`;
