...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/tags/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/tags/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/tags/${encodeURIComponent(id ?? "null")}`;
