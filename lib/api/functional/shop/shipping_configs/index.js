...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/shipping-configs/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/shipping-configs/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/shipping-configs/${encodeURIComponent(id ?? "null")}`;
