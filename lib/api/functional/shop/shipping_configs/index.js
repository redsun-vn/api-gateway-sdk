...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/shipping-configs";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/shipping-configs/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/shipping-configs";
...
(function (update) {
    ...
    update.path = (id) => `/shop/shipping-configs/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/shipping-configs/${encodeURIComponent(id?.toString() ?? "null")}`;
