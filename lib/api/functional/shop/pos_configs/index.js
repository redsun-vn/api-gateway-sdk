...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/pos-configs";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/pos-configs/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/pos-configs/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/pos-configs/${encodeURIComponent(id?.toString() ?? "null")}`;
