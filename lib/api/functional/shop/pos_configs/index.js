...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/pos-configs/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/pos-configs/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/pos-configs/${encodeURIComponent(id ?? "null")}`;
