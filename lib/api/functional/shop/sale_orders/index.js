...
exports.cancel = exports.update = exports.create = exports.duplicate = exports.$delete = exports.findOne = exports.findAll = exports.confirm = exports.send_to_partner = exports.cancel_approval = exports.reject = exports.approve = exports.submit_approval = exports.approval = exports.approval_config = exports.approvals = void 0;
const PlainFetcher_1 = require("@nestia/fetcher/lib/PlainFetcher");
exports.approvals = __importStar(require("./approvals"));
exports.approval_config = __importStar(require("./approval_config"));
exports.approval = __importStar(require("./approval"));
exports.submit_approval = __importStar(require("./submit_approval"));
exports.approve = __importStar(require("./approve"));
exports.reject = __importStar(require("./reject"));
exports.cancel_approval = __importStar(require("./cancel_approval"));
