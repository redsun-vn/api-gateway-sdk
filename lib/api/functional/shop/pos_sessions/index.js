...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/pos-sessions";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/pos-sessions/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/pos-sessions/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/pos-sessions/${encodeURIComponent(id?.toString() ?? "null")}`;
