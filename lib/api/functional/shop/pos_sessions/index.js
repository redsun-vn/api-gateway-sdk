...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/pos-sessions/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/pos-sessions/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/pos-sessions/${encodeURIComponent(id ?? "null")}`;
