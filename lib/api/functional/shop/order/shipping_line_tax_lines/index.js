...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        return `/shop/order/shipping-line-tax-lines${encoded.length ? `?${encoded}` : ""}`;
        ;
    };
...
(function (findOne) {
    ...
    findOne.path = (id) => {
        return `/shop/order/shipping-line-tax-lines/${encodeURIComponent(id ?? "null")}`;
    };
...
(function (create) {
    ...
    create.path = () => {
        return `/shop/order/shipping-line-tax-lines`;
    };
