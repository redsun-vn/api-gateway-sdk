...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/order/shipping-line-tax-lines/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/order/shipping-line-tax-lines/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/order/shipping-line-tax-lines/${encodeURIComponent(id ?? "null")}`;
