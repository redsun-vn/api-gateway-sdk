...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/order/transaction-fees",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        return `/shop/order/transaction-fees${encoded.length ? `?${encoded}` : ""}`;
        ;
    };
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/order/transaction-fees/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => {
        return `/shop/order/transaction-fees/${encodeURIComponent(id ?? "null")}`;
    };
...
(function (create) {
    ...
    create.path = () => {
        return `/shop/order/transaction-fees`;
    };
