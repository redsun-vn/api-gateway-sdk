...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        return `/shop/order/line-item-tax-lines${encoded.length ? `?${encoded}` : ""}`;
        ;
    };
...
(function (findOne) {
    ...
    findOne.path = (id) => {
        return `/shop/order/line-item-tax-lines/${encodeURIComponent(id ?? "null")}`;
    };
...
(function (create) {
    ...
    create.path = () => {
        return `/shop/order/line-item-tax-lines`;
    };
