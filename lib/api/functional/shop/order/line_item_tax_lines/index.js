...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/order/line-item-tax-lines",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/order/line-item-tax-lines";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/order/line-item-tax-lines/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/order/line-item-tax-lines/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/order/line-item-tax-lines";
...
(function (update) {
    ...
    update.path = (id) => `/shop/order/line-item-tax-lines/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/order/line-item-tax-lines/${encodeURIComponent(id?.toString() ?? "null")}`;
