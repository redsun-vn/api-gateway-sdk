...
export declare namespace findAll {
    type Output = Primitive<IResponse<IResponsePagination<IAdditionalFee.IDetailAdditionalFeeResponse>>>;
    const METADATA: {
        readonly method: "GET";
        readonly path: "/shop/order/additional-fees";
...
export declare namespace findOne {
    ...
    const METADATA: {
        readonly method: "GET";
        readonly path: "/shop/order/additional-fees/:id";
        readonly request: null;
        readonly response: {
            readonly type: "application/json";
            readonly encrypted: false;
...
export declare namespace create {
    type Input = Primitive<IAdditionalFee.ICreateAdditionalFee>;
    type Output = Primitive<IResponse<IAdditionalFee.IDetailAdditionalFeeResponse>>;
    const METADATA: {
...
export declare namespace update {
    type Input = Primitive<IAdditionalFee.IUpdateAdditionalFee>;
    type Output = Primitive<IResponse<IAdditionalFee.IDetailAdditionalFeeResponse>>;
    const METADATA: {
        readonly method: "PUT";
        readonly path: "/shop/order/additional-fees/:id";
