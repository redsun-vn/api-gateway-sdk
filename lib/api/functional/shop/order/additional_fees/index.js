...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/order/additional-fees/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/order/additional-fees/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/order/additional-fees/${encodeURIComponent(id ?? "null")}`;
