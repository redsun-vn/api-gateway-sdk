...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/order/additional-fees",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/order/additional-fees";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/order/additional-fees/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/order/additional-fees/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/order/additional-fees";
...
(function (update) {
    ...
    update.path = (id) => `/shop/order/additional-fees/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/order/additional-fees/${encodeURIComponent(id?.toString() ?? "null")}`;
