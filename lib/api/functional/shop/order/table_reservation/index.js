...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/order/table-reservation",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/order/table-reservation";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/order/table-reservation/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/order/table-reservation/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/order/table-reservation";
...
(function (update) {
    ...
    update.path = (id) => `/shop/order/table-reservation/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/order/table-reservation/${encodeURIComponent(id?.toString() ?? "null")}`;
