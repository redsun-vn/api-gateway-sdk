...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        return `/shop/order/table-reservation${encoded.length ? `?${encoded}` : ""}`;
        ;
    };
...
(function (findOne) {
    ...
    findOne.path = (id) => {
        return `/shop/order/table-reservation/${encodeURIComponent(id ?? "null")}`;
    };
...
(function (create) {
    ...
    create.path = () => {
        return `/shop/order/table-reservation`;
    };
