...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/order/line-item-selection-groups",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/order/line-item-selection-groups";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/order/line-item-selection-groups/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/order/line-item-selection-groups/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/order/line-item-selection-groups";
...
(function (update) {
    ...
    update.path = (id) => `/shop/order/line-item-selection-groups/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/order/line-item-selection-groups/${encodeURIComponent(id?.toString() ?? "null")}`;
