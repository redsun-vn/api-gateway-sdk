...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/order/line-item-selection-groups/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/order/line-item-selection-groups/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/order/line-item-selection-groups/${encodeURIComponent(id ?? "null")}`;
