...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        return `/shop/order/line-item-selection-groups${encoded.length ? `?${encoded}` : ""}`;
        ;
    };
...
(function (findOne) {
    ...
    findOne.path = (id) => {
        return `/shop/order/line-item-selection-groups/${encodeURIComponent(id ?? "null")}`;
    };
...
(function (create) {
    ...
    create.path = () => {
        return `/shop/order/line-item-selection-groups`;
    };
