...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        return `/shop/order/transactions${encoded.length ? `?${encoded}` : ""}`;
        ;
    };
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/order/transactions/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => {
        return `/shop/order/transactions/${encodeURIComponent(id ?? "null")}`;
    };
...
(function (create) {
    ...
    create.path = () => {
        return `/shop/order/transactions`;
    };
