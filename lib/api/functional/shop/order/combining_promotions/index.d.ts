...
export declare namespace findAll {
    ...
    type Output = Primitive<IResponse<IResponsePagination<ICombiningPromotion.IDetailCombiningPromotionResponse>>>;
    const METADATA: {
        readonly method: "GET";
        readonly path: "/shop/order/combining-promotions";
...
export declare namespace findOne {
    ...
    const METADATA: {
        readonly method: "GET";
        readonly path: "/shop/order/combining-promotions/:id";
        readonly request: null;
        readonly response: {
            readonly type: "application/json";
            readonly encrypted: false;
...
export declare namespace update {
    type Input = Primitive<ICombiningPromotion.IUpdateCombiningPromotion>;
    type Output = Primitive<IResponse<ICombiningPromotion.IDetailCombiningPromotionResponse>>;
    const METADATA: {
        readonly method: "PUT";
        readonly path: "/shop/order/combining-promotions/:id";
