...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        return `/shop/order/combining-promotions${encoded.length ? `?${encoded}` : ""}`;
        ;
    };
...
(function (findOne) {
    ...
    findOne.path = (id) => {
        return `/shop/order/combining-promotions/${encodeURIComponent(id ?? "null")}`;
    };
...
(function (create) {
    ...
    create.path = () => {
        return `/shop/order/combining-promotions`;
    };
