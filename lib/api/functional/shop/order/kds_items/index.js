...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/order/kds-items";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/order/kds-items/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/order/kds-items";
...
(function (update) {
    ...
    update.path = (id) => `/shop/order/kds-items/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/order/kds-items/${encodeURIComponent(id?.toString() ?? "null")}`;
