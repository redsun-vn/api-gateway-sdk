...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/order/kds-items/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/order/kds-items/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/order/kds-items/${encodeURIComponent(id ?? "null")}`;
