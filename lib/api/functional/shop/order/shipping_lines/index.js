...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/order/shipping-lines";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/order/shipping-lines/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/order/shipping-lines";
...
(function (update) {
    ...
    update.path = (id) => `/shop/order/shipping-lines/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/order/shipping-lines/${encodeURIComponent(id?.toString() ?? "null")}`;
