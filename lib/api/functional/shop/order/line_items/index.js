...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/order/line-items";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/order/line-items/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/order/line-items";
...
(function (update) {
    ...
    update.path = (id) => `/shop/order/line-items/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/order/line-items/${encodeURIComponent(id?.toString() ?? "null")}`;
