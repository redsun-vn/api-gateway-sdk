...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/order/draf-orders/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (verify) {
    ...
    verify.path = (id) => `/shop/order/draf-orders/${encodeURIComponent(id?.toString() ?? "null")}/verify`;
...
(function (confirm) {
    ...
    confirm.path = (id) => `/shop/order/draf-orders/${encodeURIComponent(id?.toString() ?? "null")}/confirm`;
...
(function (complete) {
    ...
    complete.path = (id) => `/shop/order/draf-orders/${encodeURIComponent(id?.toString() ?? "null")}/complete`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/order/draf-orders/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/order/draf-orders/${encodeURIComponent(id?.toString() ?? "null")}`;
