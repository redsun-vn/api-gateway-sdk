...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/crm/activities";
...
(function (create) {
    ...
    create.path = () => "/shop/crm/activities";
...
(function (update) {
    ...
    update.path = (id) => `/shop/crm/activities/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/crm/activities/${encodeURIComponent(id?.toString() ?? "null")}`;
