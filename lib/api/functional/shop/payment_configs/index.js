...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/payment-configs";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/payment-configs/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/payment-configs";
...
(function (update) {
    ...
    update.path = (id) => `/shop/payment-configs/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/payment-configs/${encodeURIComponent(id?.toString() ?? "null")}`;
