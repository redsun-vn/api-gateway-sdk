...
import type { IUomCategory } from "../../../../libs/shared/src/types/product-service/iuom-category";
...
export declare namespace create {
    type Input = Resolved<IUomCategory.ICreateUomCategory>;
    type Output = Primitive<IResponse<IUomCategory.IDetailUomCategoryResponse>>;
    const METADATA: {
...
export declare namespace update {
    type Input = Resolved<IUomCategory.IUpdateUomCategory>;
    type Output = Primitive<IResponse<IUomCategory.IDetailUomCategoryResponse>>;
    const METADATA: {
        readonly method: "PUT";
        readonly path: "/shop/uom-categories/:id";
