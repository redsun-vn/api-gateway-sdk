...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/uom-categories";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/uom-categories/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/uom-categories";
...
(function (update) {
    ...
    update.path = (id) => `/shop/uom-categories/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/uom-categories/${encodeURIComponent(id?.toString() ?? "null")}`;
