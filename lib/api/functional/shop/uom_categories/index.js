...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/uom-categories/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/uom-categories/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/uom-categories/${encodeURIComponent(id ?? "null")}`;
