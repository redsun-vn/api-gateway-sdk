...
exports.update = exports.create = exports.$delete = exports.findOne = exports.findAll = exports.code = void 0;
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/payments/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/payments/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/payments/${encodeURIComponent(id?.toString() ?? "null")}`;
