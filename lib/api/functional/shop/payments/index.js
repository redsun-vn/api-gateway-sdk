...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/payments/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/payments/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/payments/${encodeURIComponent(id ?? "null")}`;
