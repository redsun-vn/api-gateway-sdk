...
(function (detail) {
    ...
    detail.path = (id) => `/shop/loyalty-programs/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/loyalty-programs/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/loyalty-programs/${encodeURIComponent(id ?? "null")}`;
