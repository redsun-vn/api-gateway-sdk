...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/languages/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/languages/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/languages/${encodeURIComponent(id?.toString() ?? "null")}`;
