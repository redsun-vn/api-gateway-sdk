...
exports.$delete = exports.findOne = exports.findAll = exports.test_connection = exports.publish = exports.invoice_templates = exports.upsert = exports.download = exports.publish_with_signature = void 0;
...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/e-invoice";
        return 0 === variables.size
            ? location
            : `${location}?${variables.toString()}`;
    };
})(findAll || (exports.findAll = findAll = {}));
async function findOne(connection, provider) {
    return PlainFetcher_1.PlainFetcher.fetch(connection, {
        ...findOne.METADATA,
        template: findOne.METADATA.path,
        path: findOne.path(provider),
    });
}
...
(function (findOne) {
    ...
    findOne.path = (provider) => `/shop/e-invoice/${encodeURIComponent(provider?.toString() ?? "null")}`;
})(findOne || (exports.findOne = findOne = {}));
async function $delete(connection, provider) {
    return PlainFetcher_1.PlainFetcher.fetch(connection, {
        ...$delete.METADATA,
        template: $delete.METADATA.path,
        path: $delete.path(provider),
    });
}
...
(function ($delete) {
    ...
    $delete.path = (provider) => `/shop/e-invoice/${encodeURIComponent(provider?.toString() ?? "null")}`;
