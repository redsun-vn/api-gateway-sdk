...
(function (findOne) {
    ...
    findOne.path = (shopId) => `/shop/e-invoice/${encodeURIComponent(shopId?.toString() ?? "null")}`;
...
(function (deactive) {
    deactive.METADATA = {
        method: "DELETE",
        path: "/shop/e-invoice/:shopId/deactive",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    deactive.path = (shopId) => `/shop/e-invoice/${encodeURIComponent(shopId?.toString() ?? "null")}/deactive`;
