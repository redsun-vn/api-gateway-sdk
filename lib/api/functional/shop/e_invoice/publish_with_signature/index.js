...
(function (publishInvoiceWithSignature) {
    publishInvoiceWithSignature.METADATA = {
        method: "POST",
        path: "/shop/e-invoice/publish-with-signature/:orderId",
        request: {
    ...
    publishInvoiceWithSignature.path = (orderId) => `/shop/e-invoice/publish-with-signature/${encodeURIComponent(orderId?.toString() ?? "null")}`;
