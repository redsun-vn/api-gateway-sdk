...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/pricebooks/pricebook-items",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        return `/shop/pricebooks/pricebook-items${encoded.length ? `?${encoded}` : ""}`;
        ;
    };
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/pricebooks/pricebook-items/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => {
        return `/shop/pricebooks/pricebook-items/${encodeURIComponent(id ?? "null")}`;
    };
...
(function (create) {
    ...
    create.path = () => {
        return `/shop/pricebooks/pricebook-items`;
    };
