...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/pricebooks/pricebook-rules",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        return `/shop/pricebooks/pricebook-rules${encoded.length ? `?${encoded}` : ""}`;
        ;
    };
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/pricebooks/pricebook-rules/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => {
        return `/shop/pricebooks/pricebook-rules/${encodeURIComponent(id ?? "null")}`;
    };
...
(function (create) {
    ...
    create.path = () => {
        return `/shop/pricebooks/pricebook-rules`;
    };
