...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/pricebooks/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/pricebooks/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/pricebooks/${encodeURIComponent(id ?? "null")}`;
