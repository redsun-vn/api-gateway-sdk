...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/pricebooks";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/pricebooks/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/pricebooks/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/pricebooks/${encodeURIComponent(id?.toString() ?? "null")}`;
