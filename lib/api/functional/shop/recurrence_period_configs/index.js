...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/recurrence-period-configs",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/recurrence-period-configs";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/recurrence-period-configs/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/recurrence-period-configs/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/recurrence-period-configs";
...
(function (update) {
    ...
    update.path = (id) => `/shop/recurrence-period-configs/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/recurrence-period-configs/${encodeURIComponent(id?.toString() ?? "null")}`;
