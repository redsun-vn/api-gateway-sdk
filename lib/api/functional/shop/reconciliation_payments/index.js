...
(function (detail) {
    ...
    detail.path = (id) => `/shop/reconciliation-payments/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/reconciliation-payments/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (confirm) {
    ...
    confirm.path = (id) => `/shop/reconciliation-payments/${encodeURIComponent(id?.toString() ?? "null")}/confirm`;
