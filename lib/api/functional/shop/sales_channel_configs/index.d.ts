...
export declare namespace findAll {
    ...
    type Output = Primitive<IResponse<IResponsePagination<ISalesChannelConfig.ISalesChannelConfigResponse>>>;
    const METADATA: {
        readonly method: "GET";
...
export declare namespace create {
    type Input = Resolved<ISalesChannelConfig.ICreate>;
    type Output = Primitive<IResponse<ISalesChannelConfig.ISalesChannelConfigResponse>>;
    const METADATA: {
...
export declare namespace update {
    type Input = Resolved<ISalesChannelConfig.IUpdate>;
