...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/sales-channel-configs",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/sales-channel-configs";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/sales-channel-configs/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/sales-channel-configs/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/sales-channel-configs";
...
(function (update) {
    ...
    update.path = (id) => `/shop/sales-channel-configs/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/sales-channel-configs/${encodeURIComponent(id?.toString() ?? "null")}`;
