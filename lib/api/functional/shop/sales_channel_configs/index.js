...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/sales-channel-configs/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/sales-channel-configs/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/sales-channel-configs/${encodeURIComponent(id ?? "null")}`;
