...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/pos-printers";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/pos-printers/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/pos-printers/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/pos-printers/${encodeURIComponent(id?.toString() ?? "null")}`;
