...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/uom-uoms/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/uom-uoms/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/uom-uoms/${encodeURIComponent(id ?? "null")}`;
