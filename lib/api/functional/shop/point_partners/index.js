...
async function update(connection, partner_id, data) {
    return PlainFetcher_1.PlainFetcher.fetch({
        ...connection,
        headers: {
            ...connection.headers,
...
(function (update) {
    ...
    update.path = (partner_id) => `/shop/point-partners/${encodeURIComponent(partner_id?.toString() ?? "null")}`;
