...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/payment-methods/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/payment-methods/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/payment-methods/${encodeURIComponent(id ?? "null")}`;
