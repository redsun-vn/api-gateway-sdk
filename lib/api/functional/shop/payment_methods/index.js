...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/payment-methods";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/payment-methods/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/payment-methods/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/payment-methods";
...
(function (update) {
    ...
    update.path = (id) => `/shop/payment-methods/${encodeURIComponent(id?.toString() ?? "null")}`;
