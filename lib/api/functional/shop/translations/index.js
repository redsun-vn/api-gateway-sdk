...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/translations";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/translations/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/translations/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/translations/${encodeURIComponent(id?.toString() ?? "null")}`;
