...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/shop/product-hour-configs",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/product-hour-configs";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/shop/product-hour-configs/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/shop/product-hour-configs/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/product-hour-configs";
...
(function (update) {
    ...
    update.path = (id) => `/shop/product-hour-configs/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/product-hour-configs/${encodeURIComponent(id?.toString() ?? "null")}`;
