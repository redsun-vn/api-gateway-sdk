...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/brands/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/brands/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/brands/${encodeURIComponent(id ?? "null")}`;
