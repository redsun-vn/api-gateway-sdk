...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/brands/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/brands/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/brands/${encodeURIComponent(id?.toString() ?? "null")}`;
