...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/shop-configs/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/shop-configs/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/shop-configs/${encodeURIComponent(id ?? "null")}`;
