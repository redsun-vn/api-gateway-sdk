...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/shop-configs";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/shop-configs/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/shop-configs/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/shop-configs/${encodeURIComponent(id?.toString() ?? "null")}`;
