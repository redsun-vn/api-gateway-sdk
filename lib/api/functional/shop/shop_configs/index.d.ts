...
export declare namespace findAll {
    ...
    type Output = Primitive<IResponse<IResponsePagination<IShopConfig.IShopConfigResponse>>>;
    const METADATA: {
        readonly method: "GET";
...
export declare namespace create {
    type Input = Resolved<IShopConfig.ICreate>;
    type Output = Primitive<IResponse<IShopConfig.IShopConfigResponse>>;
    const METADATA: {
...
export declare namespace update {
    type Input = Resolved<IShopConfig.IUpdate>;
    type Output = Primitive<IResponse<false | true>>;
    const METADATA: {
        readonly method: "PUT";
        readonly path: "/shop/shop-configs/:id";
