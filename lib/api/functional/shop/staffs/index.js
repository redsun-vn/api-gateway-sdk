...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/staffs/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/staffs/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/staffs/${encodeURIComponent(id ?? "null")}`;
