...
exports.update = exports.$delete = exports.create = exports.findOne = exports.findAll = exports.reset_password = void 0;
...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        return `/shop/staffs${encoded.length ? `?${encoded}` : ""}`;
        ;
    };
...
(function (findOne) {
    ...
    findOne.path = (id) => {
        return `/shop/staffs/${encodeURIComponent(id ?? "null")}`;
    };
