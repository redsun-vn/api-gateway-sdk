...
exports.$delete = exports.getAllDevice = exports.getDevice = exports.updateDevice = exports.createDevice = void 0;
...
async function getAllDevice(connection, query) {
    return PlainFetcher_1.PlainFetcher.fetch(connection, {
        ...getAllDevice.METADATA,
        template: getAllDevice.METADATA.path,
        path: getAllDevice.path(query),
    });
}
...
(function (getAllDevice) {
    ...
    getAllDevice.path = (query) => {
        ...
        const location = "/shop/tomotek-device";
        return 0 === variables.size
            ? location
            : `${location}?${variables.toString()}`;
    };
})(getAllDevice || (exports.getAllDevice = getAllDevice = {}));
