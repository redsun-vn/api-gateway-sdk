...
(function (detail) {
    ...
    detail.path = (id) => `/shop/payment-cards/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/payment-cards/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/payment-cards/${encodeURIComponent(id ?? "null")}`;
