...
import type { IManufacturer } from "../../../../libs/shared/src/types/product-service/imanufacturer";
...
export declare namespace create {
    type Input = Resolved<IManufacturer.ICreateManufacturer>;
    type Output = Primitive<IResponse<IManufacturer.IDetailManufacturerResponse>>;
    const METADATA: {
...
export declare namespace update {
    type Input = Resolved<IManufacturer.IUpdateManufacturer>;
    type Output = Primitive<IResponse<IManufacturer.IDetailManufacturerResponse>>;
    const METADATA: {
        readonly method: "PUT";
        readonly path: "/shop/manufacturers/:id";
