...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/shop/manufacturers";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/manufacturers/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/shop/manufacturers";
...
(function (update) {
    ...
    update.path = (id) => `/shop/manufacturers/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/manufacturers/${encodeURIComponent(id?.toString() ?? "null")}`;
