...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/manufacturers/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/manufacturers/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/manufacturers/${encodeURIComponent(id ?? "null")}`;
