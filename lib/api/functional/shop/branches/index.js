...
(function (findOne) {
    ...
    findOne.path = (id) => `/shop/branches/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/shop/branches/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shop/branches/${encodeURIComponent(id ?? "null")}`;
