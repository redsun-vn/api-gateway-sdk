...
(function (upload) {
    ...
    upload.path = () => "/attachments/admin/files";
...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/attachments/admin/files";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/attachments/admin/files/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/attachments/admin/files/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/attachments/admin/files/${encodeURIComponent(id?.toString() ?? "null")}`;
