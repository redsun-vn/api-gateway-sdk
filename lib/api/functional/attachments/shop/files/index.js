...
exports.$delete = exports.update = exports.findOne = exports.findAll = exports.upload = exports.hard = void 0;
...
(function (findOne) {
    ...
    findOne.path = (id) => `/attachments/shop/files/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/attachments/shop/files/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/attachments/shop/files/${encodeURIComponent(id?.toString() ?? "null")}`;
