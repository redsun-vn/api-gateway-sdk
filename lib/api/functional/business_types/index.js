...
(function (findOne) {
    ...
    findOne.path = (id) => `/business-types/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/business-types/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/business-types/${encodeURIComponent(id?.toString() ?? "null")}`;
