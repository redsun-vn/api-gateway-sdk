...
(function (findOne) {
    ...
    findOne.path = (id) => `/business-types/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/business-types/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/business-types/${encodeURIComponent(id ?? "null")}`;
