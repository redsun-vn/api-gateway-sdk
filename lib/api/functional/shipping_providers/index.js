...
(function (schedule) {
    ...
    schedule.path = (shippingCode) => `/shipping-providers/${encodeURIComponent(shippingCode?.toString() ?? "null")}/schedule`;
...
(function (detail) {
    ...
    detail.path = (shippingCode, orderCode) => `/shipping-providers/${encodeURIComponent(shippingCode?.toString() ?? "null")}/detail/${encodeURIComponent(orderCode?.toString() ?? "null")}`;
