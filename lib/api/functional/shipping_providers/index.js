...
exports.detail = exports.schedule = exports.wards = exports.districts = exports.provinces = void 0;
...
(function (schedule) {
    ...
    schedule.path = (shippingCode) => {
        return `/shipping-providers/${encodeURIComponent(shippingCode ?? "null")}/schedule`;
    };
...
(function (detail) {
    ...
    detail.path = (shippingCode, orderCode) => {
        return `/shipping-providers/${encodeURIComponent(shippingCode ?? "null")}/detail/${encodeURIComponent(orderCode ?? "null")}`;
    };
