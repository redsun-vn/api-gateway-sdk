...
exports.findOne = exports.findAll = exports.etag = void 0;
const PlainFetcher_1 = require("@nestia/fetcher/lib/PlainFetcher");
exports.etag = __importStar(require("./etag"));
...
(function (findOne) {
    ...
    findOne.path = (id) => `/cms/documents/${encodeURIComponent(id?.toString() ?? "null")}`;
