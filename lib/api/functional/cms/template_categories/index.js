...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/cms/template-categories";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/cms/template-categories/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/cms/template-categories/${encodeURIComponent(id?.toString() ?? "null")}`;
