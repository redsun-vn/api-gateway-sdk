...
exports.findOne = exports.findAll = exports.by_handle = void 0;
const PlainFetcher_1 = require("@nestia/fetcher/lib/PlainFetcher");
exports.by_handle = __importStar(require("./by_handle"));
...
(function (findOne) {
    ...
    findOne.path = (id) => `/cms/menus/${encodeURIComponent(id?.toString() ?? "null")}`;
