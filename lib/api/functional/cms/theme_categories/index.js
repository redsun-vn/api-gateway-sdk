...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/cms/theme-categories";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/cms/theme-categories/${encodeURIComponent(id?.toString() ?? "null")}`;
