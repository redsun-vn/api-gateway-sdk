...
(function (findOne) {
    ...
    findOne.path = (id) => `/packages/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/packages/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/packages/${encodeURIComponent(id ?? "null")}`;
