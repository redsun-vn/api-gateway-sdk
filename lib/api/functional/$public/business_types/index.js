...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/public/business-types";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/public/business-types/${encodeURIComponent(id?.toString() ?? "null")}`;
