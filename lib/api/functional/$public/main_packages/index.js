...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/public/main-packages";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/public/main-packages/${encodeURIComponent(id?.toString() ?? "null")}`;
