...
async function schedule(connection, shippingCode) {
    return PlainFetcher_1.PlainFetcher.fetch(connection, {
        ...schedule.METADATA,
        template: schedule.METADATA.path,
...
(function (schedule) {
    schedule.METADATA = {
        method: "GET",
        path: "/public/shipping-providers/:shippingCode/schedule",
        request: null,
        response: {
    ...
    schedule.path = (shippingCode) => `/public/shipping-providers/${encodeURIComponent(shippingCode?.toString() ?? "null")}/schedule`;
...
(function (detail) {
    detail.METADATA = {
        method: "GET",
        path: "/public/shipping-providers/:shippingCode/detail/:orderCode",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    detail.path = (shippingCode, orderCode) => `/public/shipping-providers/${encodeURIComponent(shippingCode?.toString() ?? "null")}/detail/${encodeURIComponent(orderCode?.toString() ?? "null")}`;
