...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/public/category-business";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/public/category-business/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/public/category-business/${encodeURIComponent(id?.toString() ?? "null")}`;
