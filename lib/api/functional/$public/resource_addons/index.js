...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/public/resource-addons";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/public/resource-addons/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/public/resource-addons/${encodeURIComponent(id?.toString() ?? "null")}`;
