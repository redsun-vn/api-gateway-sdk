...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/ticket-comments";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/ticket-comments/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/admin/ticket-comments";
...
(function (update) {
    ...
    update.path = (id) => `/admin/ticket-comments/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/ticket-comments/${encodeURIComponent(id?.toString() ?? "null")}`;
