...
(function (update) {
    ...
    update.path = (id) => `/admin/notify/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/notify/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/notify/${encodeURIComponent(id?.toString() ?? "null")}`;
