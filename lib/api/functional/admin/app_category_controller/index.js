...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/admin/app-category-controller",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/app-category-controller";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/admin/app-category-controller/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/admin/app-category-controller/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/admin/app-category-controller";
...
(function (update) {
    ...
    update.path = (id) => `/admin/app-category-controller/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/app-category-controller/${encodeURIComponent(id?.toString() ?? "null")}`;
