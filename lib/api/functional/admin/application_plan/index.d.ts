...
export declare namespace findAll {
    ...
    const METADATA: {
        readonly method: "GET";
        readonly path: "/admin/application-plan";
...
export declare namespace findOne {
    ...
    const METADATA: {
        readonly method: "GET";
        readonly path: "/admin/application-plan/:id";
        readonly request: null;
        readonly response: {
            readonly type: "application/json";
            readonly encrypted: false;
...
export declare namespace create {
    type Input = Resolved<IApplicationPlan.ICreate>;
    type Output = Primitive<IResponse<IApplicationPlan.IResponse>>;
    const METADATA: {
...
export declare namespace update {
    type Input = Resolved<IApplicationPlan.IUpdate>;
    type Output = Primitive<IResponse<IApplicationPlan.IResponse>>;
    const METADATA: {
        readonly method: "PUT";
        readonly path: "/admin/application-plan/:id";
