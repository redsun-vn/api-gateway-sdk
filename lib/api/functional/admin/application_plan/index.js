...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/application-plan";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/admin/application-plan/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/admin/application-plan/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/admin/application-plan";
...
(function (update) {
    ...
    update.path = (id) => `/admin/application-plan/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/application-plan/${encodeURIComponent(id?.toString() ?? "null")}`;
