...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/customer-company";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/admin/customer-company/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/admin/customer-company/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/admin/customer-company";
...
(function (update) {
    ...
    update.path = (id) => `/admin/customer-company/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/customer-company/${encodeURIComponent(id?.toString() ?? "null")}`;
