...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/ticket-categories";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/admin/ticket-categories/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/admin/ticket-categories/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/admin/ticket-categories";
...
(function (update) {
    ...
    update.path = (id) => `/admin/ticket-categories/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/ticket-categories/${encodeURIComponent(id?.toString() ?? "null")}`;
