...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/sales-channels/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/admin/sales-channels/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/sales-channels/${encodeURIComponent(id ?? "null")}`;
