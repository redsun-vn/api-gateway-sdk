...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/sales-channels";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/sales-channels/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/admin/sales-channels";
...
(function (update) {
    ...
    update.path = (id) => `/admin/sales-channels/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/sales-channels/${encodeURIComponent(id?.toString() ?? "null")}`;
