...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/languages";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/languages/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/admin/languages/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/languages/${encodeURIComponent(id?.toString() ?? "null")}`;
