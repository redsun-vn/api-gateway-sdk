...
export declare namespace findAll {
    ...
    const METADATA: {
        readonly method: "GET";
        readonly path: "/admin/shipping-methods";
...
export declare namespace findOne {
    ...
    const METADATA: {
        readonly method: "GET";
        readonly path: "/admin/shipping-methods/:id";
        readonly request: null;
        readonly response: {
            readonly type: "application/json";
            readonly encrypted: false;
...
export declare namespace create {
    type Input = Resolved<IShippingMethod.ICreate>;
    type Output = Primitive<IResponse<IShippingMethod.IShippingMethodResponse>>;
    const METADATA: {
...
export declare namespace update {
    type Input = Resolved<IShippingMethod.IUpdate>;
