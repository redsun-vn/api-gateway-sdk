...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/shipping-methods";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/shipping-methods/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/admin/shipping-methods";
...
(function (update) {
    ...
    update.path = (id) => `/admin/shipping-methods/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/shipping-methods/${encodeURIComponent(id?.toString() ?? "null")}`;
