...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/shipping-methods/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/admin/shipping-methods/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/shipping-methods/${encodeURIComponent(id ?? "null")}`;
