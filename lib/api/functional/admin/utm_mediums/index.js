...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/utm-mediums";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/utm-mediums/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/admin/utm-mediums/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/utm-mediums/${encodeURIComponent(id?.toString() ?? "null")}`;
