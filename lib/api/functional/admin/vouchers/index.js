...
(function (createPromotionVoucher) {
    ...
    createPromotionVoucher.path = () => "/admin/vouchers";
...
(function (updatePromotionVoucher) {
    ...
    updatePromotionVoucher.path = (id) => `/admin/vouchers/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (deletePromotionVoucher) {
    ...
    deletePromotionVoucher.path = (id) => `/admin/vouchers/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (findOnePromotionVoucher) {
    ...
    findOnePromotionVoucher.path = (id) => `/admin/vouchers/${encodeURIComponent(id?.toString() ?? "null")}`;
