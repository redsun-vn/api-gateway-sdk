...
exports.$delete = exports.update = exports.create = exports.findOne = exports.findAll = exports.reports = exports.additions = void 0;
const PlainFetcher_1 = require("@nestia/fetcher/lib/PlainFetcher");
exports.additions = __importStar(require("./additions"));
...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/packages/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/admin/packages/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/packages/${encodeURIComponent(id?.toString() ?? "null")}`;
