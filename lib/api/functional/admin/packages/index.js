...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/packages/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/admin/packages/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/packages/${encodeURIComponent(id ?? "null")}`;
