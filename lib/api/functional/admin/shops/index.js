...
exports.restore = exports.$delete = exports.update = exports.findAll = exports.soft = exports.deleted = void 0;
...
(function (update) {
    ...
    update.path = (id) => `/admin/shops/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/shops/${encodeURIComponent(id ?? "null")}`;
...
(function (restore) {
    ...
    restore.path = (id) => `/admin/shops/${encodeURIComponent(id ?? "null")}/restore`;
