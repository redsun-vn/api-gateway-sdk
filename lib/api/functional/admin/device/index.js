...
(function (update) {
    ...
    update.path = (id) => `/admin/device/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/device/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/device/${encodeURIComponent(id?.toString() ?? "null")}`;
