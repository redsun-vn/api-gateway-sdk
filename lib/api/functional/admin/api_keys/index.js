...
(function (update) {
    ...
    update.path = (id) => `/admin/api-keys/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/api-keys/${encodeURIComponent(id?.toString() ?? "null")}`;
