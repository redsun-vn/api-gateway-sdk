...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/main-packages";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/main-packages/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/admin/main-packages";
...
(function (update) {
    ...
    update.path = (id) => `/admin/main-packages/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/main-packages/${encodeURIComponent(id?.toString() ?? "null")}`;
