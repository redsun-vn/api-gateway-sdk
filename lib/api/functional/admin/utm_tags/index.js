...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/utm-tags/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/admin/utm-tags/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/utm-tags/${encodeURIComponent(id?.toString() ?? "null")}`;
