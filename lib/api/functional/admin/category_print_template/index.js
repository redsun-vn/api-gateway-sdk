...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/category-print-template/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/admin/category-print-template/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/category-print-template/${encodeURIComponent(id?.toString() ?? "null")}`;
