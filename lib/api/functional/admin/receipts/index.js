...
exports.stats = exports.$delete = exports.update = exports.findOne = exports.create = exports.findAll = exports.create_subs_from_receipt = void 0;
    ...
    stats.path = (query) => {
        ...
        for (const [key, value] of Object.entries(query))
            if (undefined === value)
                ...
                variables.set(key, String(value));
        const location = "/admin/receipts/stats";
        return 0 === variables.size
            ? location
            : `${location}?${variables.toString()}`;
    };
