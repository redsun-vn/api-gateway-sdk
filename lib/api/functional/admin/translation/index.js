...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/translation";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/translation/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/admin/translation/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/translation/${encodeURIComponent(id?.toString() ?? "null")}`;
