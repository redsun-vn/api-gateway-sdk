...
(function (createItem) {
    ...
    createItem.path = (id) => {
        return `/admin/reconciliations/${encodeURIComponent(id ?? "null")}/item`;
    };
...
(function (removeItem) {
    ...
    removeItem.path = (id, itemId) => {
        return `/admin/reconciliations/${encodeURIComponent(id ?? "null")}/item/${encodeURIComponent(itemId ?? "null")}`;
    };
