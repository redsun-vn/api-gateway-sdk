...
(function (createItem) {
    ...
    createItem.path = (id) => `/admin/reconciliations/${encodeURIComponent(id ?? "null")}/item`;
...
(function (removeItem) {
    ...
    removeItem.path = (id, itemId) => `/admin/reconciliations/${encodeURIComponent(id ?? "null")}/item/${encodeURIComponent(itemId ?? "null")}`;
