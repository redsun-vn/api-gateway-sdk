...
(function (detail) {
    ...
    detail.path = (id) => `/admin/reconciliations/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/admin/reconciliations/${encodeURIComponent(id ?? "null")}`;
...
(function (cancel) {
    ...
    cancel.path = (id) => `/admin/reconciliations/${encodeURIComponent(id ?? "null")}/cancel`;
...
(function (release) {
    ...
    release.path = (id) => `/admin/reconciliations/${encodeURIComponent(id ?? "null")}/release`;
