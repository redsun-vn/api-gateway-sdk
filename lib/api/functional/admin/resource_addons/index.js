...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/resource-addons";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/resource-addons/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/admin/resource-addons";
...
(function (update) {
    ...
    update.path = (id) => `/admin/resource-addons/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/resource-addons/${encodeURIComponent(id?.toString() ?? "null")}`;
