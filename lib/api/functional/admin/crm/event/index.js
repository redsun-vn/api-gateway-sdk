...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/crm/event";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/crm/event/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/admin/crm/event/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/crm/event/${encodeURIComponent(id?.toString() ?? "null")}`;
