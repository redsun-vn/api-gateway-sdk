...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/admin/crm/lead-scoring-config-rules",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/crm/lead-scoring-config-rules";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/admin/crm/lead-scoring-config-rules/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/admin/crm/lead-scoring-config-rules/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/admin/crm/lead-scoring-config-rules";
...
(function (update) {
    ...
    update.path = (id) => `/admin/crm/lead-scoring-config-rules/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/crm/lead-scoring-config-rules/${encodeURIComponent(id?.toString() ?? "null")}`;
