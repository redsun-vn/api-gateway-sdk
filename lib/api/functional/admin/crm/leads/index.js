...
exports.$delete = exports.update = exports.create = exports.findOne = exports.findAll = exports.convert_to_deal = void 0;
...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/crm/leads";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/crm/leads/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/admin/crm/leads/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/crm/leads/${encodeURIComponent(id?.toString() ?? "null")}`;
