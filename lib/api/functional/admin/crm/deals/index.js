...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/crm/deals";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/crm/deals/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/admin/crm/deals/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/crm/deals/${encodeURIComponent(id?.toString() ?? "null")}`;
