...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/tickets/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/admin/tickets/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/tickets/${encodeURIComponent(id?.toString() ?? "null")}`;
