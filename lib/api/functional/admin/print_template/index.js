...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/print-template/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/admin/print-template/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/print-template/${encodeURIComponent(id ?? "null")}`;
