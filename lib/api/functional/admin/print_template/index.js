...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/print-template";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/print-template/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/admin/print-template";
...
(function (update) {
    ...
    update.path = (id) => `/admin/print-template/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/print-template/${encodeURIComponent(id?.toString() ?? "null")}`;
