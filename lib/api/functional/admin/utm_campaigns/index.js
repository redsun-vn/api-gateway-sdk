...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/utm-campaigns";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/utm-campaigns/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/admin/utm-campaigns";
...
(function (update) {
    ...
    update.path = (id) => `/admin/utm-campaigns/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/utm-campaigns/${encodeURIComponent(id?.toString() ?? "null")}`;
