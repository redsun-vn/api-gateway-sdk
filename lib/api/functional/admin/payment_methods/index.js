...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/payment-methods/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/admin/payment-methods/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/payment-methods/${encodeURIComponent(id ?? "null")}`;
