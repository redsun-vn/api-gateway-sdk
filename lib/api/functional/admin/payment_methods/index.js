...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/payment-methods";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/payment-methods/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/admin/payment-methods";
...
(function (update) {
    ...
    update.path = (id) => `/admin/payment-methods/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/payment-methods/${encodeURIComponent(id?.toString() ?? "null")}`;
