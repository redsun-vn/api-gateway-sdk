...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/business-types";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/business-types/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/admin/business-types";
...
(function (update) {
    ...
    update.path = (id) => `/admin/business-types/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/business-types/${encodeURIComponent(id?.toString() ?? "null")}`;
