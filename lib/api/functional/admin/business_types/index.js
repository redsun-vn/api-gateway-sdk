...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/business-types/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/admin/business-types/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/business-types/${encodeURIComponent(id ?? "null")}`;
