...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/groups/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/admin/groups/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/groups/${encodeURIComponent(id ?? "null")}`;
