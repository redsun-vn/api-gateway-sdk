...
export declare namespace findAll {
    ...
    type Output = Primitive<IResponse<IResponsePagination<INameSpace.IResponse>>>;
    const METADATA: {
        readonly method: "GET";
        readonly path: "/admin/namespace";
...
export declare namespace findOne {
    ...
    const METADATA: {
        readonly method: "GET";
        readonly path: "/admin/namespace/:id";
        readonly request: null;
        readonly response: {
            readonly type: "application/json";
            readonly encrypted: false;
...
export declare namespace create {
    type Input = Resolved<INameSpace.ICreate>;
    type Output = Primitive<IResponse<INameSpace.IResponse>>;
    const METADATA: {
...
export declare namespace $import {
    ...
    const METADATA: {
        readonly method: "POST";
        readonly path: "/admin/namespace/import";
        readonly request: {
            readonly type: "application/json";
            readonly encrypted: false;
        };
