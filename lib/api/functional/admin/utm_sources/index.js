...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/utm-sources";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/utm-sources/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/admin/utm-sources/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/utm-sources/${encodeURIComponent(id?.toString() ?? "null")}`;
