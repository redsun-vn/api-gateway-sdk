...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/subscriptions";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/subscriptions/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/subscriptions/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/admin/subscriptions";
...
(function (update) {
    ...
    update.path = (id) => `/admin/subscriptions/${encodeURIComponent(id?.toString() ?? "null")}`;
