...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/subscriptions/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/subscriptions/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/admin/subscriptions/${encodeURIComponent(id ?? "null")}`;
