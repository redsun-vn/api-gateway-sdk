...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/cms/documents";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/cms/documents/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/cms/documents/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/admin/cms/documents";
...
(function (update) {
    ...
    update.path = (id) => `/admin/cms/documents/${encodeURIComponent(id?.toString() ?? "null")}`;
