...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/cms/theme-tags";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/cms/theme-tags/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/cms/theme-tags/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/admin/cms/theme-tags";
...
(function (update) {
    ...
    update.path = (id) => `/admin/cms/theme-tags/${encodeURIComponent(id?.toString() ?? "null")}`;
