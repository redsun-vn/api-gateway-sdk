...
exports.review = exports.update = exports.create = exports.$delete = exports.findOne = exports.findAll = void 0;
...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/cms/templates";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/cms/templates/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/cms/templates/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/admin/cms/templates";
...
(function (update) {
    ...
    update.path = (id) => `/admin/cms/templates/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (review) {
    review.METADATA = {
        method: "POST",
        path: "/admin/cms/templates/review",
        request: {
            type: "application/json",
            encrypted: false,
        },
    ...
    review.path = () => "/admin/cms/templates/review";
