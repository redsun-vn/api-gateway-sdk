...
export declare namespace findAll {
    ...
    const METADATA: {
        readonly method: "GET";
        readonly path: "/admin/cms/theme-categories";
...
export declare namespace findOne {
    ...
    const METADATA: {
        readonly method: "GET";
        readonly path: "/admin/cms/theme-categories/:id";
        readonly request: null;
        readonly response: {
            readonly type: "application/json";
            readonly encrypted: false;
...
export declare namespace create {
    type Input = Resolved<IThemeCategory.ICreate>;
    type Output = Primitive<IResponse<IThemeCategory.IResponse>>;
    const METADATA: {
...
export declare namespace update {
    type Input = Resolved<IThemeCategory.IUpdate>;
    type Output = Primitive<IResponse<IThemeCategory.IResponse>>;
    const METADATA: {
        readonly method: "PUT";
        readonly path: "/admin/cms/theme-categories/:id";
