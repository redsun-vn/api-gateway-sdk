...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/cms/menus";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/cms/menus/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/cms/menus/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/admin/cms/menus/${encodeURIComponent(id?.toString() ?? "null")}`;
