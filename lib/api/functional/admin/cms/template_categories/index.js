...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/admin/cms/template-categories",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/cms/template-categories";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/admin/cms/template-categories/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/admin/cms/template-categories/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/cms/template-categories/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/admin/cms/template-categories";
...
(function (update) {
    ...
    update.path = (id) => `/admin/cms/template-categories/${encodeURIComponent(id?.toString() ?? "null")}`;
