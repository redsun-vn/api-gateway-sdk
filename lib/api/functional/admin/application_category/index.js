...
(function (findAll) {
    findAll.METADATA = {
        method: "GET",
        path: "/admin/application-category",
        request: null,
        response: {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/application-category";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/admin/application-category/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/admin/application-category/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/admin/application-category";
...
(function (update) {
    ...
    update.path = (id) => `/admin/application-category/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/application-category/${encodeURIComponent(id?.toString() ?? "null")}`;
