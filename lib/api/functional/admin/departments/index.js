...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/departments";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/departments/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/admin/departments/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/departments/${encodeURIComponent(id?.toString() ?? "null")}`;
