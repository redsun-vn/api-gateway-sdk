...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/application-main";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/admin/application-main/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/admin/application-main/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/admin/application-main";
...
(function (update) {
    ...
    update.path = (id) => `/admin/application-main/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/application-main/${encodeURIComponent(id?.toString() ?? "null")}`;
