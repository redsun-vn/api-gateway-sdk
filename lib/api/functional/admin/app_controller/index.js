...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/app-controller";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/app-controller/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/admin/app-controller";
...
(function (update) {
    ...
    update.path = (id) => `/admin/app-controller/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/app-controller/${encodeURIComponent(id?.toString() ?? "null")}`;
