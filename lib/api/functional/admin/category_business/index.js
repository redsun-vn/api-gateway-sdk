...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/category-business";
...
(function (findOne) {
    findOne.METADATA = {
        method: "GET",
        path: "/admin/category-business/:id",
        request: null,
        response: {
            type: "application/json",
            encrypted: false,
    ...
    findOne.path = (id) => `/admin/category-business/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (create) {
    ...
    create.path = () => "/admin/category-business";
...
(function (update) {
    ...
    update.path = (id) => `/admin/category-business/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/category-business/${encodeURIComponent(id?.toString() ?? "null")}`;
