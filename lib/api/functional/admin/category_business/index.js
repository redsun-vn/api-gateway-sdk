...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/category-business/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/admin/category-business/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/category-business/${encodeURIComponent(id ?? "null")}`;
