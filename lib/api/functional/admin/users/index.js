...
exports.$delete = exports.update = exports.create = exports.findOne = exports.findAll = exports.childrens = exports.password = void 0;
const PlainFetcher_1 = require("@nestia/fetcher/lib/PlainFetcher");
exports.password = __importStar(require("./password"));
exports.childrens = __importStar(require("./childrens"));
...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/users/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/admin/users/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/users/${encodeURIComponent(id?.toString() ?? "null")}`;
