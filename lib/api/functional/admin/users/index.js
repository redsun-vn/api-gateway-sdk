...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/users/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/admin/users/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/users/${encodeURIComponent(id ?? "null")}`;
