...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/admin/activities";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/admin/activities/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/admin/activities/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/admin/activities/${encodeURIComponent(id?.toString() ?? "null")}`;
