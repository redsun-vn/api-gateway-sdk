...
exports.$delete = exports.update = exports.create = exports.findOnePublic = exports.findAll = exports.code = void 0;
...
(function (findOnePublic) {
    ...
    findOnePublic.path = (id) => `/orders/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/orders/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/orders/${encodeURIComponent(id?.toString() ?? "null")}`;
