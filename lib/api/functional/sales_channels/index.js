...
(function (findOne) {
    ...
    findOne.path = (id) => `/sales-channels/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/sales-channels/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/sales-channels/${encodeURIComponent(id ?? "null")}`;
