...
(function (findOne) {
    ...
    findOne.path = (id) => `/sales-channels/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/sales-channels/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/sales-channels/${encodeURIComponent(id?.toString() ?? "null")}`;
