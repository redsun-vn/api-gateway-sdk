...
async function findProductCollectionRelation(connection, query) {
    return PlainFetcher_1.PlainFetcher.fetch(connection, {
        ...
        template: findProductCollectionRelation.METADATA.path,
...
(function (findProductCollectionRelation) {
    findProductCollectionRelation.METADATA = {
        method: "GET",
        path: "/product/collection/collection_product_relations",
        request: null,
        response: {
    ...
    findProductCollectionRelation.path = (query) => {
        ...
        const location = "/product/collection/collection_product_relations";
