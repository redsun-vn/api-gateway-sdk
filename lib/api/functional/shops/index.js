...
exports.update = exports.create = exports.restore = exports.$delete = exports.findOne = exports.findAll = exports.soft = exports.deleted = void 0;
...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        return `/shops${encoded.length ? `?${encoded}` : ""}`;
        ;
    };
...
(function (findOne) {
    ...
    findOne.path = (id) => {
        return `/shops/${encodeURIComponent(id ?? "null")}`;
    };
...
(function (restore) {
    ...
    restore.path = (id) => {
        return `/shops/${encodeURIComponent(id ?? "null")}/restore`;
    };
