...
exports.update = exports.create = exports.restore = exports.$delete = exports.findOne = exports.findAll = exports.find_by_name = exports.register_v2 = exports.register = exports.soft = exports.deleted = void 0;
...
exports.register_v2 = __importStar(require("./register_v2"));
...
(function (findOne) {
    ...
    findOne.path = (id) => `/shops/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/shops/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (restore) {
    ...
    restore.path = (id) => `/shops/${encodeURIComponent(id?.toString() ?? "null")}/restore`;
...
(function (update) {
    ...
    update.path = (id) => `/shops/${encodeURIComponent(id?.toString() ?? "null")}`;
