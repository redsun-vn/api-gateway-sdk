...
export declare namespace findAll {
    type Output = Primitive<IResponse<Array<IPaymentMethod.IPaymentMethodResponse>>>;
    const METADATA: {
        readonly method: "GET";
...
export declare namespace create {
    type Input = Primitive<IPaymentMethod.ICreate>;
    type Output = Primitive<IResponse<IPaymentMethod.IPaymentMethodResponse>>;
    const METADATA: {
...
export declare namespace update {
    type Input = Primitive<IPaymentMethod.IUpdate>;
