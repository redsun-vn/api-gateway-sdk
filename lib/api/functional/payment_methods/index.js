...
(function (findAll) {
    ...
    findAll.path = (query) => {
        ...
        const location = "/payment-methods";
...
(function (findOne) {
    ...
    findOne.path = (id) => `/payment-methods/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/payment-methods/${encodeURIComponent(id?.toString() ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/payment-methods/${encodeURIComponent(id?.toString() ?? "null")}`;
