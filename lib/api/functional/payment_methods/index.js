...
(function (findOne) {
    ...
    findOne.path = (id) => `/payment-methods/${encodeURIComponent(id ?? "null")}`;
...
(function (update) {
    ...
    update.path = (id) => `/payment-methods/${encodeURIComponent(id ?? "null")}`;
...
(function ($delete) {
    ...
    $delete.path = (id) => `/payment-methods/${encodeURIComponent(id ?? "null")}`;
